...
export class EventsApi {
  ...
  public async getEvent(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getEvent."
      );
    }
   ...
   * @param types An array of up to 20 strings containing specific event names. The list will be filtered to include only events with a matching event property.
   * @param object_id Id of related resource. The list will be filtered to include events that are related to the resource with this id.
  ...
  public async listEvents(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listEvents."
      );
    }
    ...
    if (object_id !== undefined) {
      localVarQueryParameters["object_id"] = ObjectSerializer.serialize(
        object_id,
        "string"
      );
    }
