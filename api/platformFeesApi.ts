...
import { ListPlatformFees200Response } from "../model/listPlatformFees200Response";
import { PlatformFee } from "../model/platformFee";
...
export enum PlatformFeesApiApiKeys {
  TilledApiKey,
}

export class PlatformFeesApi {
  ...
  public setApiKey(key: PlatformFeesApiApiKeys, value: string) {
    (this.authentications as any)[PlatformFeesApiApiKeys[key]].apiKey = value;
  }
  ...
  public async getPlatformFee(
  ...
  ): Promise<{ response: http.IncomingMessage; body: PlatformFee }> {
    const localVarPath =
      this.basePath +
      "/v1/platform-fees/{id}".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getPlatformFee."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getPlatformFee."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: PlatformFee }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              ...
              if (
                ...
                body = ObjectSerializer.deserialize(body, "PlatformFee");
   ...
   * @param charge_id Only return application fees for the charge specified by this charge id.
  ...
  public async listPlatformFees(
    ...
    body: ListPlatformFees200Response;
  }> {
    const localVarPath = this.basePath + "/v1/platform-fees";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listPlatformFees."
      );
    }
    ...
    if (charge_id !== undefined) {
      localVarQueryParameters["charge_id"] = ObjectSerializer.serialize(
        charge_id,
        "string"
      );
    }
