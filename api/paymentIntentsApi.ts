...
import { ListPaymentIntents200Response } from "../model/listPaymentIntents200Response";
import { PaymentIntent } from "../model/paymentIntent";
import { PaymentIntentCancelParams } from "../model/paymentIntentCancelParams";
import { PaymentIntentCaptureParams } from "../model/paymentIntentCaptureParams";
import { PaymentIntentConfirmParams } from "../model/paymentIntentConfirmParams";
import { PaymentIntentCreateParams } from "../model/paymentIntentCreateParams";
...
export class PaymentIntentsApi {
   ...
   * @param id
   * @param PaymentIntentCancelParams
   */
  public async cancelPaymentIntent(
    ...
    const localVarPath =
      this.basePath +
      "/v1/payment-intents/{id}/cancel".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling cancelPaymentIntent."
      );
    }
    ...
    if (
      PaymentIntentCancelParams === null ||
      PaymentIntentCancelParams === undefined
    ) {
      throw new Error(
        "Required parameter PaymentIntentCancelParams was null or undefined when calling cancelPaymentIntent."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param PaymentIntentCaptureParams
   */
  public async capturePaymentIntent(
    ...
    const localVarPath =
      this.basePath +
      "/v1/payment-intents/{id}/capture".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling capturePaymentIntent."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling capturePaymentIntent."
      );
    }

    // verify required parameter 'PaymentIntentCaptureParams' is not null or undefined
    if (
      PaymentIntentCaptureParams === null ||
      PaymentIntentCaptureParams === undefined
    ) {
      throw new Error(
        "Required parameter PaymentIntentCaptureParams was null or undefined when calling capturePaymentIntent."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param PaymentIntentConfirmParams
   */
  public async confirmPaymentIntent(
    ...
    const localVarPath =
      this.basePath +
      "/v1/payment-intents/{id}/confirm".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling confirmPaymentIntent."
      );
    }
    ...
    if (
      PaymentIntentConfirmParams === null ||
      PaymentIntentConfirmParams === undefined
    ) {
      throw new Error(
        "Required parameter PaymentIntentConfirmParams was null or undefined when calling confirmPaymentIntent."
      );
    }
  ...
  public async createPaymentIntent(
    ...
    const localVarPath = this.basePath + "/v1/payment-intents";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createPaymentIntent."
      );
    }

    // verify required parameter 'PaymentIntentCreateParams' is not null or undefined
    if (
      PaymentIntentCreateParams === null ||
      PaymentIntentCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter PaymentIntentCreateParams was null or undefined when calling createPaymentIntent."
      );
    }
  ...
  public async getPaymentIntent(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getPaymentIntent."
      );
    }
   ...
   * @param status Only return PaymentIntents whose status is included by this array. Examples: &#x60;/v1/payment-intents?status&#x3D;succeeded,requires_payment_method&#x60; and &#x60;/v1/payment-intents?status&#x3D;succeeded&amp;status&#x3D;requires_payment_method&#x60;.
   * @param include_connected_accounts Whether or not to include the results from any connected accounts.
   * @param subscription_id The ID of the subscription whose payment intents will be retrieved.
   * @param q Supports searching by &#x60;payment_intent.id&#x60;, &#x60;payment_intent.amount&#x60;, &#x60;payment_method.billing_details.name&#x60;, &#x60;payment_method.details.last4&#x60;, &#x60;payment_method.details.last2&#x60;, &#x60;customer.first_name&#x60;, &#x60;customer.last_name&#x60;
   * @param customer_id The ID of the customer whose payment intents will be retrieved.
  ...
  public async listPaymentIntents(
    ...
    response: http.IncomingMessage;
    body: ListPaymentIntents200Response;
  }> {
    const localVarPath = this.basePath + "/v1/payment-intents";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listPaymentIntents."
      );
    }
    ...
    if (status !== undefined) {
      localVarQueryParameters["status"] = ObjectSerializer.serialize(
        status,
        "Array<'canceled' | 'processing' | 'requires_action' | 'requires_capture' | 'requires_confirmation' | 'requires_payment_method' | 'succeeded'>"
      );
    }
    ...
    if (subscription_id !== undefined) {
      localVarQueryParameters["subscription_id"] = ObjectSerializer.serialize(
        subscription_id,
        "string"
      );
    }
  ...
  public async updatePaymentIntent(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updatePaymentIntent."
      );
    }
    ...
    if (
      PaymentIntentUpdateParams === null ||
      PaymentIntentUpdateParams === undefined
    ) {
      throw new Error(
        "Required parameter PaymentIntentUpdateParams was null or undefined when calling updatePaymentIntent."
      );
    }
