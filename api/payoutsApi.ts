...
export class PayoutsApi {
   ...
   * @param id
   * @param include An array of optional include parameters, specifying extra properties to return. Currently for this endpoint only accepts \&#39;transaction_count\&#39;. In the query parameters, this is specified as include&#x3D;value1,value2,value3,etc.
   */
  public async getPayout(
  ...
  ): Promise<{ response: http.IncomingMessage; body: Payout }> {
    const localVarPath =
      this.basePath +
      "/v1/payouts/{id}".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getPayout."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: Payout }>(
        (resolve, reject) => {
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param created_at_gte Minimum &#x60;created_at&#x60; value to filter by (inclusive). Cannot be paired with paid_at_gte or paid_at_lte.
   * @param created_at_lte Maximum &#x60;created_at&#x60; value to filter by (inclusive). Cannot be paired with paid_at_gte or paid_at_lte.
   * @param paid_at_gte Minimum &#x60;paid_at&#x60; value to filter by (inclusive). Cannot be paired with created_at_gte or created_at_lte.
   * @param paid_at_lte Maximum &#x60;paid_at&#x60; value to filter by (inclusive). Cannot be paired with created_at_gte or created_at_lte.
   * @param status Only return payouts that have the given status.
   * @param include An array of optional include parameters, specifying extra properties to return. Currently for this endpoint only accepts \&#39;transaction_count\&#39;. In the query parameters, this is specified as include&#x3D;value1,value2,value3,etc.
  ...
  public async listPayouts(
    ...
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ListPayouts200Response }> {
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listPayouts."
      );
    }
    ...
    if (paid_at_gte !== undefined) {
      localVarQueryParameters["paid_at_gte"] = ObjectSerializer.serialize(
        paid_at_gte,
        "Date"
      );
    }
    ...
    if (paid_at_lte !== undefined) {
      localVarQueryParameters["paid_at_lte"] = ObjectSerializer.serialize(
        paid_at_lte,
        "Date"
      );
    }
    ...
    if (status !== undefined) {
      localVarQueryParameters["status"] = ObjectSerializer.serialize(
        status,
        "'canceled' | 'failed' | 'in_transit' | 'paid' | 'pending'"
      );
    }
