...
export const OnboardingApiAxiosParamCreator = function (
  ...
  return {
    ...
    getMerchantApplication: async (
      ...
      const localVarPath = `/v1/applications/{account_id}`.replace(
        `{${"account_id"}}`,
    ...
    submitMerchantApplication: async (
      ...
      const localVarPath = `/v1/applications/{account_id}/submit`.replace(
        `{${"account_id"}}`,
        encodeURIComponent(String(account_id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateMerchantApplication: async (
      account_id: string,
  ...
  return {
    ...
    async getMerchantApplication(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<MerchantApplication>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMerchantApplication(
          account_id,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.submitMerchantApplication(
          account_id,
          options
        );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateMerchantApplication(
          account_id,
          MerchantApplicationCreateParams,
          options
        );
...
export const OnboardingApiFactory = function (
  ...
  return {
    ...
    getMerchantApplication(
      requestParameters: OnboardingApiGetMerchantApplicationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<MerchantApplication> {
      return localVarFp
        .getMerchantApplication(requestParameters.account_id, options)
    ...
    submitMerchantApplication(
      requestParameters: OnboardingApiSubmitMerchantApplicationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<object> {
      return localVarFp
        .submitMerchantApplication(requestParameters.account_id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Updates a merchant application by overwriting all properties.
     ...
     */
    updateMerchantApplication(
      requestParameters: OnboardingApiUpdateMerchantApplicationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<MerchantApplication> {
      return localVarFp
        .updateMerchantApplication(
          requestParameters.account_id,
          requestParameters.MerchantApplicationCreateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
...
export class OnboardingApi extends BaseAPI {
   ...
   * @memberof OnboardingApi
   */
  public submitMerchantApplication(
    requestParameters: OnboardingApiSubmitMerchantApplicationRequest,
    options?: AxiosRequestConfig
  ) {
    return OnboardingApiFp(this.configuration)
   ...
   * @memberof OnboardingApi
   */
  public updateMerchantApplication(
    requestParameters: OnboardingApiUpdateMerchantApplicationRequest,
    options?: AxiosRequestConfig
  ) {
    return OnboardingApiFp(this.configuration)
