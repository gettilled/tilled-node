...
import { PlatformFeeRefund } from "../model/platformFeeRefund";
...
export enum PlatformFeeRefundsApiApiKeys {
  TilledApiKey,
}

export class PlatformFeeRefundsApi {
  ...
  public setApiKey(key: PlatformFeeRefundsApiApiKeys, value: string) {
    (this.authentications as any)[PlatformFeeRefundsApiApiKeys[key]].apiKey =
      value;
  }
   ...
   * @param refund_id
   */
  public async getPlatformFeeRefund(
    tilled_account: string,
    id: string,
    refund_id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: PlatformFeeRefund }> {
    const localVarPath =
      this.basePath +
      "/v1/platform-fees/{id}/refunds/{refund_id}"
        ...
        .replace(
          "{" + "refund_id" + "}",
          encodeURIComponent(String(refund_id))
        );
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getPlatformFeeRefund."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getPlatformFeeRefund."
      );
    }

    // verify required parameter 'refund_id' is not null or undefined
    if (refund_id === null || refund_id === undefined) {
      throw new Error(
        "Required parameter refund_id was null or undefined when calling getPlatformFeeRefund."
      );
    }
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(body, "PlatformFeeRefund");
