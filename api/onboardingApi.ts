...
export class OnboardingApi {
   ...
   * @param account_id The id of the associated connected (i.e. merchant) account.
   */
  public async getMerchantApplication(
    account_id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: MerchantApplication }> {
    const localVarPath =
      this.basePath +
      "/v1/applications/{account_id}".replace(
        "{" + "account_id" + "}",
    ...
    if (account_id === null || account_id === undefined) {
      throw new Error(
        "Required parameter account_id was null or undefined when calling getMerchantApplication."
      );
    }
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(body, "MerchantApplication");
   ...
   * @param account_id The id of the associated connected (i.e. merchant) account.
   */
  public async submitMerchantApplication(
    account_id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: object }> {
    const localVarPath =
      this.basePath +
      "/v1/applications/{account_id}/submit".replace(
        "{" + "account_id" + "}",
        encodeURIComponent(String(account_id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (account_id === null || account_id === undefined) {
      throw new Error(
        "Required parameter account_id was null or undefined when calling submitMerchantApplication."
      );
    }
   ...
   * @param account_id The id of the associated connected (i.e. merchant) account.
   * @param MerchantApplicationCreateParams
   */
  public async updateMerchantApplication(
    account_id: string,
    ...
    if (account_id === null || account_id === undefined) {
      throw new Error(
        "Required parameter account_id was null or undefined when calling updateMerchantApplication."
      );
    }

    // verify required parameter 'MerchantApplicationCreateParams' is not null or undefined
    if (
      MerchantApplicationCreateParams === null ||
      MerchantApplicationCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter MerchantApplicationCreateParams was null or undefined when calling updateMerchantApplication."
      );
    }
