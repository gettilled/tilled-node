 ...
 * @export
 */
export const PlatformFeeRefundsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getPlatformFeeRefund: async (
      ...
      assertParamExists("getPlatformFeeRefund", "refund_id", refund_id);
 ...
 * @export
 */
export const PlatformFeeRefundsApiFp = function (
  configuration?: Configuration
) {
  ...
  return {
    ...
    async getPlatformFeeRefund(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<PlatformFeeRefund>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getPlatformFeeRefund(
          tilled_account,
          id,
          refund_id,
          options
 ...
 * @export
 */
export const PlatformFeeRefundsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     * Retrieves the details of a specific refund stored on the platform fee.
     * @summary Get a Platform Fee Refund
     * @param {PlatformFeeRefundsApiGetPlatformFeeRefundRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getPlatformFeeRefund(
      requestParameters: PlatformFeeRefundsApiGetPlatformFeeRefundRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PlatformFeeRefund> {
      return localVarFp
        .getPlatformFeeRefund(
...
/**
 * Request parameters for getPlatformFeeRefund operation in PlatformFeeRefundsApi.
 * @export
 * @interface PlatformFeeRefundsApiGetPlatformFeeRefundRequest
 */
export interface PlatformFeeRefundsApiGetPlatformFeeRefundRequest {
  /**
   * The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @type {string}
   * @memberof PlatformFeeRefundsApiGetPlatformFeeRefund
   */
...
export class PlatformFeeRefundsApi extends BaseAPI {
   ...
   */
  public getPlatformFeeRefund(
    requestParameters: PlatformFeeRefundsApiGetPlatformFeeRefundRequest,
    options?: AxiosRequestConfig
  ) {
    return PlatformFeeRefundsApiFp(this.configuration)
      .getPlatformFeeRefund(
        requestParameters.tilled_account,
        requestParameters.id,
        requestParameters.refund_id,
