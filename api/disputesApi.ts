...
import { DisputeEvidenceCreateParams } from "../model/disputeEvidenceCreateParams";
import { ListDisputes200Response } from "../model/listDisputes200Response";
...
export class DisputesApi {
   ...
   * @param id
   * @param DisputeEvidenceCreateParams
   */
  public async createDisputeEvidence(
    ...
    body: ListDisputes200Response;
  }> {
    const localVarPath =
      this.basePath +
      "/v1/disputes/{id}".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createDisputeEvidence."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling createDisputeEvidence."
      );
    }

    // verify required parameter 'DisputeEvidenceCreateParams' is not null or undefined
    if (
      DisputeEvidenceCreateParams === null ||
      DisputeEvidenceCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter DisputeEvidenceCreateParams was null or undefined when calling createDisputeEvidence."
      );
    }
  ...
  public async getDispute(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getDispute."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: Dispute }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
  ...
  public async listDisputes(
    ...
    created_at_lte?: Date,
    status?: Array<
      "needs_response" | "under_review" | "closed" | "won" | "lost"
    >,
    offset?: number,
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listDisputes."
      );
    }
    ...
    if (status !== undefined) {
      localVarQueryParameters["status"] = ObjectSerializer.serialize(
        status,
        "Array<'needs_response' | 'under_review' | 'closed' | 'won' | 'lost'>"
      );
    }
