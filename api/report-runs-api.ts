 ...
 * @export
 */
export const ReportRunsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getReportRun: async (
      ...
      const localVarPath = `/v1/report-runs/{id}`.replace(
        `{${"id"}}`,
...
export const ReportRunsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ReportRunsApiAxiosParamCreator(configuration);
  return {
    /**
     * Creates a Report Run
     * @summary Create a Report Run
    ...
    async createReportRun(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportRun>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createReportRun(
        tilled_account,
        ReportRunCreateParams,
        options
      );
    ...
    async getReportRun(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReportRun>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getReportRun(
        tilled_account,
        id,
        options
      );
    ...
    async listReportRuns(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListReportRuns200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listReportRuns(
        tilled_account,
        ReportRunRetrieveParams,
        type,
        status,
 ...
 * @export
 */
export const ReportRunsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    createReportRun(
      requestParameters: ReportRunsApiCreateReportRunRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ReportRun> {
      return localVarFp
        .createReportRun(
          requestParameters.tilled_account,
          requestParameters.ReportRunCreateParams,
          options
        )
     ...
     */
    getReportRun(
      requestParameters: ReportRunsApiGetReportRunRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ReportRun> {
      return localVarFp
        .getReportRun(
     ...
     */
    listReportRuns(
      requestParameters: ReportRunsApiListReportRunsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListReportRuns200Response> {
      return localVarFp
        .listReportRuns(
          requestParameters.tilled_account,
          requestParameters.ReportRunRetrieveParams,
...
export class ReportRunsApi extends BaseAPI {
  ...
  public createReportRun(
    ...
    return ReportRunsApiFp(this.configuration)
      .createReportRun(
        requestParameters.tilled_account,
        requestParameters.ReportRunCreateParams,
        options
