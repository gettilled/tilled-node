 ...
 * @export
 */
export const ProductCodesApiAxiosParamCreator = function (
...
export const ProductCodesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ProductCodesApiAxiosParamCreator(configuration);
  return {
    /**
     * *Deprecated: Use Pricing Templates to configure merchant accounts during onboarding.*  Returns a list of ProductCodes available to a given `partner` account. These are the product codes that are available to be assigned to `merchant` accounts during merchant onboarding.
     * @summary List an Account\'s Product Codes
    ...
    async listProductCodes(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListProductCodes200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listProductCodes(
          tilled_account,
          offset,
          limit,
          options
 ...
 * @export
 */
export const ProductCodesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    listProductCodes(
      requestParameters: ProductCodesApiListProductCodesRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListProductCodes200Response> {
      return localVarFp
        .listProductCodes(
...
export class ProductCodesApi extends BaseAPI {
   ...
   */
  public listProductCodes(
    requestParameters: ProductCodesApiListProductCodesRequest,
    options?: AxiosRequestConfig
  ) {
    return ProductCodesApiFp(this.configuration)
      .listProductCodes(
        requestParameters.tilled_account,
        requestParameters.offset,
        requestParameters.limit,
