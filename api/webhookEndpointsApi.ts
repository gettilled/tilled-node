...
import { WebhookEndpointCreateParams } from "../model/webhookEndpointCreateParams";
import { WebhookEndpointUpdateParams } from "../model/webhookEndpointUpdateParams";
...
export enum WebhookEndpointsApiApiKeys {
  TilledApiKey,
}
...
export class WebhookEndpointsApi {
  ...
  public setApiKey(key: WebhookEndpointsApiApiKeys, value: string) {
    (this.authentications as any)[WebhookEndpointsApiApiKeys[key]].apiKey =
      value;
  }
   ...
   * @param WebhookEndpointCreateParams
   */
  public async createWebhookEndpoint(
    tilled_account: string,
    WebhookEndpointCreateParams: WebhookEndpointCreateParams,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: WebhookEndpoint }> {
    const localVarPath = this.basePath + "/v1/webhook-endpoints";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createWebhookEndpoint."
      );
    }

    // verify required parameter 'WebhookEndpointCreateParams' is not null or undefined
    if (
      WebhookEndpointCreateParams === null ||
      WebhookEndpointCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter WebhookEndpointCreateParams was null or undefined when calling createWebhookEndpoint."
      );
    }
  ...
  public async deleteWebhookEndpoint(
    ...
    const localVarPath =
      this.basePath +
      "/v1/webhook-endpoints/{id}".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling deleteWebhookEndpoint."
      );
    }
  ...
  public async getWebhookEndpoint(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getWebhookEndpoint."
      );
    }
  ...
  public async listWebhookEndpoints(
    ...
    response: http.IncomingMessage;
    body: ListWebhookEndpoints200Response;
  }> {
    const localVarPath = this.basePath + "/v1/webhook-endpoints";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listWebhookEndpoints."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param WebhookEndpointUpdateParams
   */
  public async updateWebhookEndpoint(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updateWebhookEndpoint."
      );
    }
    ...
    if (
      WebhookEndpointUpdateParams === null ||
      WebhookEndpointUpdateParams === undefined
    ) {
      throw new Error(
        "Required parameter WebhookEndpointUpdateParams was null or undefined when calling updateWebhookEndpoint."
      );
    }
