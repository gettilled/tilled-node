...
export const RefundsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getRefund: async (
      ...
      const localVarPath = `/v1/refunds/{id}`.replace(
        `{${"id"}}`,
...
export const RefundsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getRefund(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Refund>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getRefund(
        tilled_account,
        id,
        options
      );
    ...
    async listRefunds(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListRefunds200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listRefunds(
        tilled_account,
        metadata,
        offset,
        limit,
...
export const RefundsApiFactory = function (
  ...
  return {
     ...
     */
    createRefund(
      requestParameters: RefundsApiCreateRefundRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Refund> {
      return localVarFp
        .createRefund(
          requestParameters.tilled_account,
          requestParameters.RefundCreateParams,
          options
        )
     ...
     */
    getRefund(
      requestParameters: RefundsApiGetRefundRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Refund> {
      return localVarFp
        .getRefund(
     ...
     */
    listRefunds(
      requestParameters: RefundsApiListRefundsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListRefunds200Response> {
      return localVarFp
        .listRefunds(
