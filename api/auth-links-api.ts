 ...
 * @export
 */
export const AuthLinksApiAxiosParamCreator = function (
...
export const AuthLinksApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async createAuthLink(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<AuthLinkDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createAuthLink(
        tilled_account,
        AuthLinkCreateParams,
        options
      );
 ...
 * @export
 */
export const AuthLinksApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    createAuthLink(
      requestParameters: AuthLinksApiCreateAuthLinkRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<AuthLinkDto> {
      return localVarFp
        .createAuthLink(
          requestParameters.tilled_account,
          requestParameters.AuthLinkCreateParams,
          options
        )
...
export class AuthLinksApi extends BaseAPI {
  ...
  public createAuthLink(
    ...
    return AuthLinksApiFp(this.configuration)
      .createAuthLink(
        requestParameters.tilled_account,
        requestParameters.AuthLinkCreateParams,
        options
