...
import { ListReportRuns200Response } from "../model/listReportRuns200Response";
import { ReportRun } from "../model/reportRun";
import { ReportRunCreateParams } from "../model/reportRunCreateParams";
import { ReportRunRetrieveParams } from "../model/reportRunRetrieveParams";
...
export enum ReportRunsApiApiKeys {
  TilledApiKey,
}
...
export class ReportRunsApi {
  ...
  public setApiKey(key: ReportRunsApiApiKeys, value: string) {
    (this.authentications as any)[ReportRunsApiApiKeys[key]].apiKey = value;
  }
   ...
   * @param ReportRunCreateParams
   */
  public async createReportRun(
    tilled_account: string,
    ReportRunCreateParams: ReportRunCreateParams,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ReportRun }> {
    const localVarPath = this.basePath + "/v1/report-runs";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createReportRun."
      );
    }

    // verify required parameter 'ReportRunCreateParams' is not null or undefined
    if (ReportRunCreateParams === null || ReportRunCreateParams === undefined) {
      throw new Error(
        "Required parameter ReportRunCreateParams was null or undefined when calling createReportRun."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: ReportRun }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              ...
              if (
                ...
                body = ObjectSerializer.deserialize(body, "ReportRun");
  ...
  public async getReportRun(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getReportRun."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getReportRun."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param ReportRunRetrieveParams
   * @param type Only return ReportRuns whose type is included by this array. Examples: &#x60;?type&#x3D;payments_summary_1,payouts_summary_2&#x60; and &#x60;?type&#x3D;payouts_summary_2&#x60;.
   * @param status Only return ReportRuns whose status is included by this array. Examples: &#x60;?status&#x3D;finished&#x60; and &#x60;?status&#x3D;finished,queued&#x60;.
  ...
  public async listReportRuns(
    ...
    body: ListReportRuns200Response;
  }> {
    const localVarPath = this.basePath + "/v1/report-runs";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listReportRuns."
      );
    }

    // verify required parameter 'ReportRunRetrieveParams' is not null or undefined
    if (
      ReportRunRetrieveParams === null ||
      ReportRunRetrieveParams === undefined
    ) {
      throw new Error(
        "Required parameter ReportRunRetrieveParams was null or undefined when calling listReportRuns."
      );
    }
    ...
    if (type !== undefined) {
      localVarQueryParameters["type"] = ObjectSerializer.serialize(
        type,
        "Array<'payments_summary_1' | 'payouts_summary_1' | 'payouts_summary_2' | 'fees_summary_1' | 'processing_summary_1'>"
      );
    }
