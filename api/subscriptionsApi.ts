...
import { SubscriptionCreateParams } from "../model/subscriptionCreateParams";
import { SubscriptionPauseParams } from "../model/subscriptionPauseParams";
import { SubscriptionRetryParams } from "../model/subscriptionRetryParams";
import { SubscriptionUpdateParams } from "../model/subscriptionUpdateParams";
...
export class SubscriptionsApi {
  ...
  public async cancelSubscription(
    ...
    const localVarPath =
      this.basePath +
      "/v1/subscriptions/{id}/cancel".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling cancelSubscription."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param SubscriptionCreateParams
   */
  public async createSubscription(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createSubscription."
      );
    }
    ...
    if (
      ...
      SubscriptionCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter SubscriptionCreateParams was null or undefined when calling createSubscription."
      );
    }
  ...
  public async getSubscription(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getSubscription."
      );
    }
   ...
   * @param customer_id The ID of the customer whose subscriptions will be retrieved.
   * @param status The status of the subscriptions to retrieve.
   * @param next_payment_at_lte Maximum &#x60;next_payment_at&#x60; value to filter by (inclusive).
   * @param next_payment_at_gte Minimum &#x60;next_payment_at&#x60; value to filter by (inclusive).
  ...
  public async listSubscriptions(
    ...
    next_payment_at_lte?: Date,
    next_payment_at_gte?: Date,
    offset?: number,
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{
    response: http.IncomingMessage;
    body: ListSubscriptions200Response;
  }> {
    const localVarPath = this.basePath + "/v1/subscriptions";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listSubscriptions."
      );
    }
    ...
    if (status !== undefined) {
      localVarQueryParameters["status"] = ObjectSerializer.serialize(
        status,
        "'active' | 'canceled' | 'past_due' | 'paused' | 'pending'"
      );
    }

    if (next_payment_at_lte !== undefined) {
      localVarQueryParameters["next_payment_at_lte"] =
        ObjectSerializer.serialize(next_payment_at_lte, "Date");
    }

    if (next_payment_at_gte !== undefined) {
      localVarQueryParameters["next_payment_at_gte"] =
        ObjectSerializer.serialize(next_payment_at_gte, "Date");
    }
  ...
  public async pauseSubscription(
    ...
    const localVarPath =
      this.basePath +
      "/v1/subscriptions/{id}/pause".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling pauseSubscription."
      );
    }
    ...
    if (
      SubscriptionPauseParams === null ||
      SubscriptionPauseParams === undefined
    ) {
      throw new Error(
        "Required parameter SubscriptionPauseParams was null or undefined when calling pauseSubscription."
      );
    }
  ...
  public async resumeSubscription(
    ...
    const localVarPath =
      this.basePath +
      "/v1/subscriptions/{id}/resume".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling resumeSubscription."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param SubscriptionRetryParams
   */
  public async retrySubscription(
    tilled_account: string,
    id: string,
    ...
    const localVarPath =
      this.basePath +
      "/v1/subscriptions/{id}/retry".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling retrySubscription."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling retrySubscription."
      );
    }

    // verify required parameter 'SubscriptionRetryParams' is not null or undefined
    if (
      SubscriptionRetryParams === null ||
      SubscriptionRetryParams === undefined
    ) {
      throw new Error(
        "Required parameter SubscriptionRetryParams was null or undefined when calling retrySubscription."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param SubscriptionUpdateParams
   */
  public async updateSubscription(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updateSubscription."
      );
    }
    ...
    if (
      ...
      SubscriptionUpdateParams === undefined
    ) {
      throw new Error(
        "Required parameter SubscriptionUpdateParams was null or undefined when calling updateSubscription."
      );
    }
