...
export const FilesApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteFile: async (
      ...
      const localVarPath = `/v1/files/{id}`.replace(
        `{${"id"}}`,
    ...
    getContentsOfFile: async (
      ...
      const localVarPath = `/v1/files/{id}/contents`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getContentsOfFile(
          tilled_account,
          id,
          options
        );
    ...
    async listFiles(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListFiles200Response>
    > {
...
export const FilesApiFactory = function (
  ...
  return {
     ...
     */
    getContentsOfFile(
      requestParameters: FilesApiGetContentsOfFileRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<File> {
      return localVarFp
        .getContentsOfFile(
     ...
     */
    listFiles(
      requestParameters: FilesApiListFilesRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListFiles200Response> {
      return localVarFp
        .listFiles(
          requestParameters.tilled_account,
          requestParameters.purposes,
...
export class FilesApi extends BaseAPI {
  ...
  public getFile(
    ...
    return FilesApiFp(this.configuration)
      .getFile(requestParameters.tilled_account, requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath));
  }
