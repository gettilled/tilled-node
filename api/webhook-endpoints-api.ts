 ...
 * @export
 */
export const WebhookEndpointsApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteWebhookEndpoint: async (
      ...
      const localVarPath = `/v1/webhook-endpoints/{id}`.replace(
        `{${"id"}}`,
...
export const WebhookEndpointsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    WebhookEndpointsApiAxiosParamCreator(configuration);
  return {
    /**
     * A webhook endpoint must have a url and a list of enabled_events. The specified url will be notified about events from all connected accounts along with your account.
     * @summary Create a Webhook Endpoint
    ...
    async createWebhookEndpoint(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<WebhookEndpoint>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createWebhookEndpoint(
          tilled_account,
          WebhookEndpointCreateParams,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteWebhookEndpoint(
          tilled_account,
          id,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getWebhookEndpoint(
          tilled_account,
          id,
          options
        );
    ...
    async listWebhookEndpoints(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListWebhookEndpoints200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listWebhookEndpoints(
          tilled_account,
          offset,
          limit,
          options
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateWebhookEndpoint(
          tilled_account,
          id,
          WebhookEndpointUpdateParams,
          options
 ...
 * @export
 */
export const WebhookEndpointsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    createWebhookEndpoint(
      requestParameters: WebhookEndpointsApiCreateWebhookEndpointRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<WebhookEndpoint> {
      return localVarFp
        .createWebhookEndpoint(
          requestParameters.tilled_account,
          requestParameters.WebhookEndpointCreateParams,
          options
        )
     ...
     */
    deleteWebhookEndpoint(
      requestParameters: WebhookEndpointsApiDeleteWebhookEndpointRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<object> {
      return localVarFp
        .deleteWebhookEndpoint(
     ...
     */
    getWebhookEndpoint(
      requestParameters: WebhookEndpointsApiGetWebhookEndpointRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<WebhookEndpoint> {
      return localVarFp
        .getWebhookEndpoint(
     ...
     */
    listWebhookEndpoints(
      requestParameters: WebhookEndpointsApiListWebhookEndpointsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListWebhookEndpoints200Response> {
      return localVarFp
        .listWebhookEndpoints(
     ...
     */
    updateWebhookEndpoint(
      requestParameters: WebhookEndpointsApiUpdateWebhookEndpointRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<WebhookEndpoint> {
      return localVarFp
        .updateWebhookEndpoint(
          requestParameters.tilled_account,
          requestParameters.id,
          requestParameters.WebhookEndpointUpdateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
...
export class WebhookEndpointsApi extends BaseAPI {
  ...
  public createWebhookEndpoint(
    ...
    return WebhookEndpointsApiFp(this.configuration)
      .createWebhookEndpoint(
        requestParameters.tilled_account,
        requestParameters.WebhookEndpointCreateParams,
        options
