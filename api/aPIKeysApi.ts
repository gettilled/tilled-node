...
import { ApiKeyCreateParams } from "../model/apiKeyCreateParams";
import { ApiKeyUpdateParams } from "../model/apiKeyUpdateParams";
...
export class APIKeysApi {
   ...
   * @param ApiKeyCreateParams
   */
  public async createAPIKey(
    tilled_account: string,
    ApiKeyCreateParams: ApiKeyCreateParams,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ApiKey }> {
    const localVarPath = this.basePath + "/v1/api-keys";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createAPIKey."
      );
    }

    // verify required parameter 'ApiKeyCreateParams' is not null or undefined
    if (ApiKeyCreateParams === null || ApiKeyCreateParams === undefined) {
      throw new Error(
        "Required parameter ApiKeyCreateParams was null or undefined when calling createAPIKey."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: ApiKey }>(
        (resolve, reject) => {
  ...
  public async deleteAPIKey(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling deleteAPIKey."
      );
    }
  ...
  public async listAPIKeys(
    ...
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ListAPIKeys200Response }> {
    const localVarPath = this.basePath + "/v1/api-keys";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listAPIKeys."
      );
    }
  ...
  public async updateAPIKey(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updateAPIKey."
      );
    }
    ...
    if (ApiKeyUpdateParams === null || ApiKeyUpdateParams === undefined) {
      throw new Error(
        "Required parameter ApiKeyUpdateParams was null or undefined when calling updateAPIKey."
      );
    }
