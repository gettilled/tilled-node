...
import { ListRefunds200Response } from "../model/listRefunds200Response";
import { Refund } from "../model/refund";
import { RefundCreateParams } from "../model/refundCreateParams";
...
export class RefundsApi {
  ...
  public async createRefund(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createRefund."
      );
    }

    // verify required parameter 'RefundCreateParams' is not null or undefined
    if (RefundCreateParams === null || RefundCreateParams === undefined) {
      throw new Error(
        "Required parameter RefundCreateParams was null or undefined when calling createRefund."
      );
    }
  ...
  public async getRefund(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getRefund."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getRefund."
      );
    }
  ...
  public async listRefunds(
    ...
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ListRefunds200Response }> {
    const localVarPath = this.basePath + "/v1/refunds";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listRefunds."
      );
    }
