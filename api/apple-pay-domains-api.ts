 ...
 * @export
 */
export const ApplePayDomainsApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteApplePayDomain: async (
      ...
      const localVarPath = `/v1/apple-pay-domains/{id}`.replace(
        `{${"id"}}`,
...
export const ApplePayDomainsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ApplePayDomainsApiAxiosParamCreator(configuration);
  return {
    /**
     * Creates an Apple Pay Domain for verification
     * @summary Create an Apple Pay Domain
     ...
     * @throws {RequiredError}
     */
    async createApplePayDomain(
      tilled_account: string,
      ApplePayDomainCreateParams: ApplePayDomainCreateParams,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApplePayDomain>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createApplePayDomain(
          tilled_account,
          ApplePayDomainCreateParams,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteApplePayDomain(
          id,
          tilled_account,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getApplePayDomain(
          id,
          tilled_account,
          options
        );
    ...
    async listApplePayDomains(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListApplePayDomains200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listApplePayDomains(
          tilled_account,
          offset,
          limit,
          options
 ...
 * @export
 */
export const ApplePayDomainsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    createApplePayDomain(
      requestParameters: ApplePayDomainsApiCreateApplePayDomainRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ApplePayDomain> {
      return localVarFp
        .createApplePayDomain(
          requestParameters.tilled_account,
          requestParameters.ApplePayDomainCreateParams,
          options
        )
     ...
     */
    deleteApplePayDomain(
      requestParameters: ApplePayDomainsApiDeleteApplePayDomainRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<object> {
      return localVarFp
        .deleteApplePayDomain(
     ...
     */
    getApplePayDomain(
      requestParameters: ApplePayDomainsApiGetApplePayDomainRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ApplePayDomain> {
      return localVarFp
        .getApplePayDomain(
     ...
     */
    listApplePayDomains(
      requestParameters: ApplePayDomainsApiListApplePayDomainsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListApplePayDomains200Response> {
      return localVarFp
        .listApplePayDomains(
...
export class ApplePayDomainsApi extends BaseAPI {
   ...
   */
  public createApplePayDomain(
    requestParameters: ApplePayDomainsApiCreateApplePayDomainRequest,
    options?: AxiosRequestConfig
  ) {
    return ApplePayDomainsApiFp(this.configuration)
      .createApplePayDomain(
        requestParameters.tilled_account,
        requestParameters.ApplePayDomainCreateParams,
        options
