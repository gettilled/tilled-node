 ...
 * @export
 */
export const PlatformFeesApiAxiosParamCreator = function (
  ...
  return {
    ...
    getPlatformFee: async (
      ...
      const localVarPath = `/v1/platform-fees/{id}`.replace(
        `{${"id"}}`,
...
export const PlatformFeesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    PlatformFeesApiAxiosParamCreator(configuration);
  return {
    /**
     * Retrieves the details of a platform fee that your account has collected. The same information is returned when when refunding the application fee.
     * @summary Get a Platform Fee
    ...
    async getPlatformFee(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlatformFee>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getPlatformFee(
        tilled_account,
        id,
        options
      );
    ...
    async listPlatformFees(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListPlatformFees200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listPlatformFees(
          tilled_account,
          created_at_gte,
          created_at_lte,
          charge_id,
 ...
 * @export
 */
export const PlatformFeesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getPlatformFee(
      requestParameters: PlatformFeesApiGetPlatformFeeRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PlatformFee> {
      return localVarFp
        .getPlatformFee(
     ...
     */
    listPlatformFees(
      requestParameters: PlatformFeesApiListPlatformFeesRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListPlatformFees200Response> {
      return localVarFp
        .listPlatformFees(
...
export class PlatformFeesApi extends BaseAPI {
  ...
  public getPlatformFee(
    ...
    return PlatformFeesApiFp(this.configuration)
      .getPlatformFee(
        requestParameters.tilled_account,
        requestParameters.id,
        options
