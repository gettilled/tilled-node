...
import { ListProductCodes200Response } from "../model/listProductCodes200Response";
...
export enum ProductCodesApiApiKeys {
  TilledApiKey,
}

export class ProductCodesApi {
  ...
  public setApiKey(key: ProductCodesApiApiKeys, value: string) {
    (this.authentications as any)[ProductCodesApiApiKeys[key]].apiKey = value;
  }
  ...
  public async listProductCodes(
    ...
    body: ListProductCodes200Response;
  }> {
    const localVarPath = this.basePath + "/v1/product-codes";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listProductCodes."
      );
    }
