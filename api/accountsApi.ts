...
import { AccountCapabilityCreateParams } from "../model/accountCapabilityCreateParams";
import { AccountCapabilityUpdateParams } from "../model/accountCapabilityUpdateParams";
import { AccountCreateParams } from "../model/accountCreateParams";
import { AccountUpdateParams } from "../model/accountUpdateParams";
import { ListConnectedAccounts200Response } from "../model/listConnectedAccounts200Response";
...
export class AccountsApi {
   ...
   * @param AccountCapabilityCreateParams
   */
  public async addAccountCapability(
    tilled_account: string,
    AccountCapabilityCreateParams: AccountCapabilityCreateParams,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath = this.basePath + "/v1/accounts/capabilities";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling addAccountCapability."
      );
    }

    // verify required parameter 'AccountCapabilityCreateParams' is not null or undefined
    if (
      AccountCapabilityCreateParams === null ||
      AccountCapabilityCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter AccountCapabilityCreateParams was null or undefined when calling addAccountCapability."
      );
    }
  ...
  public async createConnectedAccount(
    ...
    const localVarPath = this.basePath + "/v1/accounts/connected";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createConnectedAccount."
      );
    }

    // verify required parameter 'AccountCreateParams' is not null or undefined
    if (AccountCreateParams === null || AccountCreateParams === undefined) {
      throw new Error(
        "Required parameter AccountCreateParams was null or undefined when calling createConnectedAccount."
      );
    }
    ...
    return interceptorPromise.then(() => {
      ...
      return new Promise<{ response: http.IncomingMessage; body: Account }>(
        (resolve, reject) => {
          localVarRequest(localVarRequestOptions, (error, response, body) => {
            if (error) {
              reject(error);
   ...
   * @param id
   */
  public async deleteAccountCapability(
    tilled_account: string,
    id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath =
      this.basePath +
      "/v1/accounts/capabilities/{id}".replace(
        "{" + "id" + "}",
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling deleteAccountCapability."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling deleteAccountCapability."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   */
  public async deleteConnectedAccount(
    tilled_account: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath = this.basePath + "/v1/accounts/connected";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling deleteConnectedAccount."
      );
    }
  ...
  public async getAccount(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getAccount."
      );
    }
   ...
   * @param q The partial search of text fields. Supports searching by &#x60;account.name&#x60;, &#x60;account.business_profile.legal_name&#x60;, &#x60;account.id&#x60;, &#x60;account.email&#x60;, &#x60;user.name&#x60;, &#x60;user.email&#x60;
   * @param sort The sort parameters, value:direction. Possible values: &#x60;name&#x60;, &#x60;created_at&#x60;. Possible directions:  &#x60;asc&#x60;, &#x60;desc&#x60;  For example &#x60;name:asc&#x60;.  Default: &#x60;created_at:desc&#x60;
  ...
  public async listConnectedAccounts(
    ...
    body: ListConnectedAccounts200Response;
  }> {
    const localVarPath = this.basePath + "/v1/accounts/connected";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listConnectedAccounts."
      );
    }
  ...
  public async updateAccount(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updateAccount."
      );
    }

    // verify required parameter 'AccountUpdateParams' is not null or undefined
    if (AccountUpdateParams === null || AccountUpdateParams === undefined) {
      throw new Error(
        "Required parameter AccountUpdateParams was null or undefined when calling updateAccount."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   * @param id
   * @param AccountCapabilityUpdateParams
   */
  public async updateAccountCapability(
    tilled_account: string,
    id: string,
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling updateAccountCapability."
      );
    }
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling updateAccountCapability."
      );
    }

    // verify required parameter 'AccountCapabilityUpdateParams' is not null or undefined
    if (
      AccountCapabilityUpdateParams === null ||
      AccountCapabilityUpdateParams === undefined
    ) {
      throw new Error(
        "Required parameter AccountCapabilityUpdateParams was null or undefined when calling updateAccountCapability."
      );
    }
