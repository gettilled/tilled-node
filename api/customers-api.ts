...
export const CustomersApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteCustomer: async (
      ...
      const localVarPath = `/v1/customers/{id}`.replace(
        `{${"id"}}`,
  ...
  return {
    ...
    async listCustomers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListCustomers200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listCustomers(
        tilled_account,
        metadata,
        q,
        offset,
...
export const CustomersApiFactory = function (
  ...
  return {
     ...
     */
    createCustomer(
      requestParameters: CustomersApiCreateCustomerRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Customer> {
      return localVarFp
        .createCustomer(
          requestParameters.tilled_account,
          requestParameters.CustomerCreateParams,
          options
        )
     ...
     */
    deleteCustomer(
      requestParameters: CustomersApiDeleteCustomerRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<object> {
      return localVarFp
        .deleteCustomer(
     ...
     */
    getCustomer(
      requestParameters: CustomersApiGetCustomerRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Customer> {
      return localVarFp
        .getCustomer(
     ...
     */
    listCustomers(
      requestParameters: CustomersApiListCustomersRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListCustomers200Response> {
      return localVarFp
        .listCustomers(
     ...
     */
    updateCustomer(
      requestParameters: CustomersApiUpdateCustomerRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Customer> {
      return localVarFp
        .updateCustomer(
          requestParameters.tilled_account,
          requestParameters.id,
          requestParameters.CustomerUpdateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
