...
export const EventsApiFactory = function (
  ...
  return {
     ...
     */
    getEvent(
      requestParameters: EventsApiGetEventRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<Event> {
      return localVarFp
        .getEvent(
     ...
     */
    listEvents(
      requestParameters: EventsApiListEventsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListEvents200Response> {
      return localVarFp
        .listEvents(
...
export class EventsApi extends BaseAPI {
  ...
  public getEvent(
    ...
    return EventsApiFp(this.configuration)
      .getEvent(requestParameters.tilled_account, requestParameters.id, options)
