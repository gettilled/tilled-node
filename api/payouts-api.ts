  ...
  return {
    ...
    listPayouts: async (
      ...
      if (paid_at_gte !== undefined) {
        localVarQueryParameter["paid_at_gte"] =
          (paid_at_gte as any) instanceof Date
            ? (paid_at_gte as any).toISOString()
            : paid_at_gte;
      }

      if (paid_at_lte !== undefined) {
        localVarQueryParameter["paid_at_lte"] =
          (paid_at_lte as any) instanceof Date
  ...
  return {
    ...
    async listPayouts(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListPayouts200Response>
    > {
    ...
    listPayouts(
      ...
      return localVarFp
        .listPayouts(
          ...
          requestParameters.paid_at_gte,
          requestParameters.paid_at_lte,
