...
export const CheckoutSessionsApiAxiosParamCreator = function (
  ...
  return {
    ...
    expireCheckoutSession: async (
      ...
      const localVarPath = `/v1/checkout-sessions/{id}/expire`.replace(
        `{${"id"}}`,
    ...
    getCheckoutSession: async (
      ...
      const localVarPath = `/v1/checkout-sessions/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const CheckoutSessionsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.expireCheckoutSession(
          tilled_account,
          id,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getCheckoutSession(
          tilled_account,
          id,
          options
        );
    ...
    async listCheckoutSessions(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListCheckoutSessions200Response>
    > {
      const localVarAxiosArgs =
...
export const CheckoutSessionsApiFactory = function (
  ...
  return {
     ...
     */
    createCheckoutSession(
      requestParameters: CheckoutSessionsApiCreateCheckoutSessionRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<CheckoutSession> {
      return localVarFp
        .createCheckoutSession(
          requestParameters.tilled_account,
          requestParameters.CheckoutSessionCreateParams,
          options
        )
     ...
     */
    expireCheckoutSession(
      requestParameters: CheckoutSessionsApiExpireCheckoutSessionRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<CheckoutSession> {
      return localVarFp
        .expireCheckoutSession(
     ...
     */
    getCheckoutSession(
      requestParameters: CheckoutSessionsApiGetCheckoutSessionRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<CheckoutSession> {
      return localVarFp
        .getCheckoutSession(
     ...
     */
    listCheckoutSessions(
      requestParameters: CheckoutSessionsApiListCheckoutSessionsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListCheckoutSessions200Response> {
      return localVarFp
        .listCheckoutSessions(
          ...
          requestParameters.payment_intent_id,
