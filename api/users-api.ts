...
export const UsersApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    checkUserInvitation: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists("checkUserInvitation", "id", id);
      const localVarPath = `/v1/user-invitations/check/{id}`.replace(
        `{${"id"}}`,
    ...
    deleteUser: async (
      ...
      const localVarPath = `/v1/users/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    deleteUserInvitation: async (
      ...
      const localVarPath = `/v1/user-invitations/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    resendUserInvitation: async (
      ...
      const localVarPath = `/v1/user-invitations/{id}/resend`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
  ...
  return {
    ...
    async checkUserInvitation(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<UserInvitationCheck>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.checkUserInvitation(id, options);
    ...
    async createUserInvitation(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<UserInvitation>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createUserInvitation(
          tilled_account,
          UserInvitationCreateParams,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteUserInvitation(
          id,
          tilled_account,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getUserInvitation(
          id,
          tilled_account,
          options
        );
    ...
    async listUserInvitations(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListUserInvitations200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listUserInvitations(
          tilled_account,
          offset,
          limit,
          options
    ...
    async login(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<LoginDto>
    > {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.refreshAccessToken(
          AccessTokenRefreshParams,
          options
        );
      return createRequestFunction(
    ...
    async register(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RegisterDto>
    > {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.resendUserInvitation(
          id,
          tilled_account,
          options
        );
...
export const UsersApiFactory = function (
  ...
  return {
     ...
     */
    checkUserInvitation(
      requestParameters: UsersApiCheckUserInvitationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UserInvitationCheck> {
      return localVarFp
        .checkUserInvitation(requestParameters.id, options)
    ...
    createUser(
      ...
      return localVarFp
        .createUser(
          ...
          requestParameters.UserCreateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    createUserInvitation(
      requestParameters: UsersApiCreateUserInvitationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UserInvitation> {
      return localVarFp
        .createUserInvitation(
          requestParameters.tilled_account,
          requestParameters.UserInvitationCreateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    deleteUserInvitation(
      requestParameters: UsersApiDeleteUserInvitationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<object> {
      return localVarFp
        .deleteUserInvitation(
    ...
    forgotPassword(
      ...
      return localVarFp
        .forgotPassword(requestParameters.ForgotPasswordParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Retrieves the user with the given ID.
     ...
     */
    getUserInvitation(
      requestParameters: UsersApiGetUserInvitationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UserInvitation> {
      return localVarFp
        .getUserInvitation(
     ...
     */
    listUserInvitations(
      requestParameters: UsersApiListUserInvitationsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListUserInvitations200Response> {
      return localVarFp
        .listUserInvitations(
    ...
    login(
      ...
      return localVarFp
        .login(requestParameters.LoginParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Invalidates the refresh token for a user.
     ...
     */
    refreshAccessToken(
      requestParameters: UsersApiRefreshAccessTokenRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<void> {
      return localVarFp
        .refreshAccessToken(requestParameters.AccessTokenRefreshParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Creates a Tilled user and simultaneously creates a `partner` account. *Note: This resource should almost never be used by an existing Tilled customer.*
    ...
    register(
      ...
      options?: AxiosRequestConfig
    ): AxiosPromise<RegisterDto> {
      return localVarFp
        .register(requestParameters.RegisterParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Resends the user invitation with the given ID.
     ...
     */
    resendUserInvitation(
      requestParameters: UsersApiResendUserInvitationRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<UserInvitation> {
      return localVarFp
        .resendUserInvitation(
    ...
    resetPassword(
      ...
      return localVarFp
        .resetPassword(requestParameters.UserResetPasswordParams, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Updates the user. Any parameters not provided will be left unchanged.
    ...
    updateUser(
      ...
      return localVarFp
        .updateUser(
          requestParameters.tilled_account,
          requestParameters.id,
          requestParameters.UserUpdateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
...
export class UsersApi extends BaseAPI {
  ...
  public getUser(
    ...
    return UsersApiFp(this.configuration)
      .getUser(requestParameters.tilled_account, requestParameters.id, options)
      .then((request) => request(this.axios, this.basePath));
  }
