 ...
 * @export
 */
export const PricingTemplatesApiAxiosParamCreator = function (
  ...
  return {
    ...
    getPricingTemplate: async (
      ...
      const localVarPath = `/v1/pricing-templates/{id}`.replace(
        `{${"id"}}`,
    ...
    listPricingTemplates: async (
      ...
      if (merchant_activation_status !== undefined) {
        localVarQueryParameter["merchant_activation_status"] =
...
export const PricingTemplatesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    PricingTemplatesApiAxiosParamCreator(configuration);
  return {
    /**
     * Retrieves the details of the pricing template with the given ID.
     * @summary Get a Pricing Template
    ...
    async getPricingTemplate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<PricingTemplate>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getPricingTemplate(
          tilled_account,
          id,
          options
        );
    ...
    async listPricingTemplates(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListPricingTemplates200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listPricingTemplates(
          tilled_account,
          status,
          type,
          merchant_account_id,
 ...
 * @export
 */
export const PricingTemplatesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getPricingTemplate(
      requestParameters: PricingTemplatesApiGetPricingTemplateRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PricingTemplate> {
      return localVarFp
        .getPricingTemplate(
     ...
     */
    listPricingTemplates(
      requestParameters: PricingTemplatesApiListPricingTemplatesRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListPricingTemplates200Response> {
      return localVarFp
        .listPricingTemplates(
          ...
          requestParameters.merchant_account_id,
          requestParameters.merchant_activation_status,
...
export class PricingTemplatesApi extends BaseAPI {
  ...
  public getPricingTemplate(
    ...
    return PricingTemplatesApiFp(this.configuration)
      .getPricingTemplate(
        requestParameters.tilled_account,
        requestParameters.id,
        options
