 ...
 * @export
 */
export const BalanceTransactionsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getBalanceTransaction: async (
      ...
      const localVarPath = `/v1/balance-transactions/{id}`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    getBalanceTransactionsSummary: async (
      tilled_account: string,
      time_unit?: "day" | "month",
      time_zone?:
        | "Africa/Abidjan"
 ...
 * @export
 */
export const BalanceTransactionsApiFp = function (
  configuration?: Configuration
) {
  const localVarAxiosParamCreator =
    BalanceTransactionsApiAxiosParamCreator(configuration);
  return {
    /**
     * Retrieves the balance transaction with the given ID.
     * @summary Get a Balance Transaction
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBalanceTransaction(
          tilled_account,
          id,
          options
        );
     ...
     * @throws {RequiredError}
     */
    async getBalanceTransactionsSummary(
      tilled_account: string,
      time_unit?: "day" | "month",
      time_zone?:
        | "Africa/Abidjan"
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<BalanceTransactionsSummary>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBalanceTransactionsSummary(
          tilled_account,
          time_unit,
          time_zone,
          created_at_gte,
    ...
    async listBalanceTransactions(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListBalanceTransactions200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listBalanceTransactions(
          tilled_account,
          created_at_gte,
          created_at_lte,
          type,
 ...
 * @export
 */
export const BalanceTransactionsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    getBalanceTransaction(
      requestParameters: BalanceTransactionsApiGetBalanceTransactionRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<BalanceTransaction> {
      return localVarFp
        .getBalanceTransaction(
     ...
     */
    getBalanceTransactionsSummary(
      requestParameters: BalanceTransactionsApiGetBalanceTransactionsSummaryRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<BalanceTransactionsSummary> {
      return localVarFp
        .getBalanceTransactionsSummary(
          requestParameters.tilled_account,
          requestParameters.time_unit,
     ...
     */
    listBalanceTransactions(
      requestParameters: BalanceTransactionsApiListBalanceTransactionsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListBalanceTransactions200Response> {
      return localVarFp
        .listBalanceTransactions(
          ...
          requestParameters.source_id,
          requestParameters.payout_id,
...
export class BalanceTransactionsApi extends BaseAPI {
   ...
   */
  public getBalanceTransaction(
    requestParameters: BalanceTransactionsApiGetBalanceTransactionRequest,
    options?: AxiosRequestConfig
  ) {
    return BalanceTransactionsApiFp(this.configuration)
      .getBalanceTransaction(
        requestParameters.tilled_account,
        requestParameters.id,
        options
   ...
   * @memberof BalanceTransactionsApi
   */
  public getBalanceTransactionsSummary(
    requestParameters: BalanceTransactionsApiGetBalanceTransactionsSummaryRequest,
    options?: AxiosRequestConfig
  ) {
    return BalanceTransactionsApiFp(this.configuration)
   ...
   * @memberof BalanceTransactionsApi
   */
  public listBalanceTransactions(
    requestParameters: BalanceTransactionsApiListBalanceTransactionsRequest,
    options?: AxiosRequestConfig
  ) {
    return BalanceTransactionsApiFp(this.configuration)
