 ...
 * @export
 */
export const DisputesApiAxiosParamCreator = function (
  ...
  return {
    ...
    createDisputeEvidence: async (
      ...
      const localVarPath = `/v1/disputes/{id}`.replace(
        `{${"id"}}`,
  ...
  return {
    ...
    async createDisputeEvidence(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListDisputes200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createDisputeEvidence(
          tilled_account,
          id,
          DisputeEvidenceCreateParams,
          options
    ...
    async getDispute(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Dispute>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getDispute(
        tilled_account,
        id,
        options
      );
 ...
 * @export
 */
export const DisputesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
     ...
     */
    createDisputeEvidence(
      requestParameters: DisputesApiCreateDisputeEvidenceRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListDisputes200Response> {
      return localVarFp
        .createDisputeEvidence(
          ...
          requestParameters.DisputeEvidenceCreateParams,
          options
        )
     ...
     */
    listDisputes(
      requestParameters: DisputesApiListDisputesRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListDisputes200Response> {
      return localVarFp
        .listDisputes(
...
export class DisputesApi extends BaseAPI {
   ...
   */
  public createDisputeEvidence(
    requestParameters: DisputesApiCreateDisputeEvidenceRequest,
    options?: AxiosRequestConfig
  ) {
    return DisputesApiFp(this.configuration)
      .createDisputeEvidence(
        requestParameters.tilled_account,
        requestParameters.id,
        requestParameters.DisputeEvidenceCreateParams,
