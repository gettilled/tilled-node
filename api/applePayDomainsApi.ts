...
import { ApplePayDomainCreateParams } from "../model/applePayDomainCreateParams";
import { ListApplePayDomains200Response } from "../model/listApplePayDomains200Response";
...
export enum ApplePayDomainsApiApiKeys {
  TilledApiKey,
}

export class ApplePayDomainsApi {
  ...
  public setApiKey(key: ApplePayDomainsApiApiKeys, value: string) {
    (this.authentications as any)[ApplePayDomainsApiApiKeys[key]].apiKey =
      value;
  }
   ...
   * @param ApplePayDomainCreateParams
   */
  public async createApplePayDomain(
    tilled_account: string,
    ApplePayDomainCreateParams: ApplePayDomainCreateParams,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ApplePayDomain }> {
    const localVarPath = this.basePath + "/v1/apple-pay-domains";
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling createApplePayDomain."
      );
    }

    // verify required parameter 'ApplePayDomainCreateParams' is not null or undefined
    if (
      ApplePayDomainCreateParams === null ||
      ApplePayDomainCreateParams === undefined
    ) {
      throw new Error(
        "Required parameter ApplePayDomainCreateParams was null or undefined when calling createApplePayDomain."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   */
  public async deleteApplePayDomain(
    id: string,
    tilled_account: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
    ...
    const localVarPath =
      this.basePath +
      "/v1/apple-pay-domains/{id}".replace(
        "{" + "id" + "}",
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling deleteApplePayDomain."
      );
    }
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling deleteApplePayDomain."
      );
    }
   ...
   * @param tilled_account The id of the Tilled Account (usually starting with the prefix &#x60;acct_&#x60;) that the request is performed on behalf of.
   */
  public async getApplePayDomain(
    id: string,
    tilled_account: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: ApplePayDomain }> {
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling getApplePayDomain."
      );
    }
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling getApplePayDomain."
      );
    }
   ...
   */
  public async listApplePayDomains(
    tilled_account: string,
    offset?: number,
    limit?: number,
    options: { headers: { [name: string]: string } } = { headers: {} }
    ...
    response: http.IncomingMessage;
    body: ListApplePayDomains200Response;
  }> {
    const localVarPath = this.basePath + "/v1/apple-pay-domains";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
    ...
    if (tilled_account === null || tilled_account === undefined) {
      throw new Error(
        "Required parameter tilled_account was null or undefined when calling listApplePayDomains."
      );
    }
          ...
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(
                body,
                "ListApplePayDomains200Response"
              );
              resolve({ response: response, body: body });
            } else {
              reject(new HttpError(response, body, response.statusCode));
