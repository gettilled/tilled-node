 ...
 * @export
 */
export const PaymentMethodsApiAxiosParamCreator = function (
  ...
  return {
    ...
    attachPaymentMethodToCustomer: async (
      ...
      const localVarPath = `/v1/payment-methods/{id}/attach`.replace(
        `{${"id"}}`,
     ...
     * @throws {RequiredError}
     */
    createAchDebitSingleUseToken: async (
      tilled_account: string,
     ...
     * @throws {RequiredError}
     */
    detachPaymentMethodFromCustomer: async (
      tilled_account: string,
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      const localVarPath = `/v1/payment-methods/{id}/detach`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getPaymentMethod: async (
      ...
      const localVarPath = `/v1/payment-methods/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const PaymentMethodsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    PaymentMethodsApiAxiosParamCreator(configuration);
  return {
    /**
     * Attaches a PaymentMethod to a Customer. This effectively changes the payment method from single-use to reusable.
     * @summary Attach a Payment Method to a Customer
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.attachPaymentMethodToCustomer(
          tilled_account,
          id,
          PaymentMethodAttachParams,
          options
     ...
     * @throws {RequiredError}
     */
    async createAchDebitSingleUseToken(
      tilled_account: string,
      PaymentMethodCreateAchDebitSingleUseTokenParams: PaymentMethodCreateAchDebitSingleUseTokenParams,
      options?: AxiosRequestConfig
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<AchDebitSingleUseToken>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createAchDebitSingleUseToken(
          tilled_account,
          PaymentMethodCreateAchDebitSingleUseTokenParams,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.detachPaymentMethodFromCustomer(
          tilled_account,
          id,
          options
        );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getPaymentMethod(
          tilled_account,
          id,
          options
        );
    ...
    async listPaymentMethods(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ListPaymentMethods200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.listPaymentMethods(
          tilled_account,
          type,
          customer_id,
          metadata,
...
export const PaymentMethodsApiFactory = function (
  ...
  return {
     ...
     */
    attachPaymentMethodToCustomer(
      requestParameters: PaymentMethodsApiAttachPaymentMethodToCustomerRequest,
      options?: AxiosRequestConfig
      ...
      return localVarFp
        .attachPaymentMethodToCustomer(
          ...
          requestParameters.PaymentMethodAttachParams,
          options
        )
     ...
     */
    createAchDebitSingleUseToken(
      requestParameters: PaymentMethodsApiCreateAchDebitSingleUseTokenRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<AchDebitSingleUseToken> {
      return localVarFp
        .createAchDebitSingleUseToken(
          requestParameters.tilled_account,
          requestParameters.PaymentMethodCreateAchDebitSingleUseTokenParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    createPaymentMethod(
      requestParameters: PaymentMethodsApiCreatePaymentMethodRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PaymentMethod> {
      return localVarFp
        .createPaymentMethod(
          requestParameters.tilled_account,
          requestParameters.PaymentMethodCreateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    detachPaymentMethodFromCustomer(
      requestParameters: PaymentMethodsApiDetachPaymentMethodFromCustomerRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PaymentMethod> {
      return localVarFp
        .detachPaymentMethodFromCustomer(
     ...
     */
    getPaymentMethod(
      requestParameters: PaymentMethodsApiGetPaymentMethodRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PaymentMethod> {
      return localVarFp
        .getPaymentMethod(
     ...
     */
    listPaymentMethods(
      requestParameters: PaymentMethodsApiListPaymentMethodsRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<ListPaymentMethods200Response> {
      return localVarFp
        .listPaymentMethods(
     ...
     */
    updatePaymentMethod(
      requestParameters: PaymentMethodsApiUpdatePaymentMethodRequest,
      options?: AxiosRequestConfig
    ): AxiosPromise<PaymentMethod> {
      return localVarFp
        .updatePaymentMethod(
          requestParameters.tilled_account,
          requestParameters.id,
          requestParameters.PaymentMethodUpdateParams,
          options
        )
        .then((request) => request(axios, basePath));
    },
...
export class PaymentMethodsApi extends BaseAPI {
   ...
   * @memberof PaymentMethodsApi
   */
  public createAchDebitSingleUseToken(
    requestParameters: PaymentMethodsApiCreateAchDebitSingleUseTokenRequest,
    options?: AxiosRequestConfig
  ) {
    return PaymentMethodsApiFp(this.configuration)
   ...
   * @memberof PaymentMethodsApi
   */
  public detachPaymentMethodFromCustomer(
    requestParameters: PaymentMethodsApiDetachPaymentMethodFromCustomerRequest,
    options?: AxiosRequestConfig
  ) {
    return PaymentMethodsApiFp(this.configuration)
