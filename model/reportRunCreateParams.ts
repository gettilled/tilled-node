...
export class ReportRunCreateParams {
  /**
   * The type of a Report Run.
   */
  "type": ReportRunCreateParams.Type;
  ...
  static getAttributeTypeMap() {
    return ReportRunCreateParams.attributeTypeMap;
  }
}

export namespace ReportRunCreateParams {
  export enum Type {
    PAYMENTS_SUMMARY_1 = <any>"payments_summary_1",
    PAYOUTS_SUMMARY_1 = <any>"payouts_summary_1",
    PAYOUTS_SUMMARY_2 = <any>"payouts_summary_2",
    FEES_SUMMARY_1 = <any>"fees_summary_1",
    PROCESSING_SUMMARY_1 = <any>"processing_summary_1",
  }
}
