...
export class AchDebitDetails {
   ...
   * Account type
   */
  "account_type"?: AchDebitDetails.AccountType;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: "AchDebitDetails.AccountType",
    },
  ];

  static getAttributeTypeMap() {
    return AchDebitDetails.attributeTypeMap;
  }
}

export namespace AchDebitDetails {
