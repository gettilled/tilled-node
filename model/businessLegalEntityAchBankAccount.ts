 ...
 */
export class BusinessLegalEntityAchBankAccount {
  /**
   ...
   */
  "type"?: BusinessLegalEntityAchBankAccount.Type;
  /**
  ...
  static getAttributeTypeMap() {
    return BusinessLegalEntityAchBankAccount.attributeTypeMap;
  }
}

export namespace BusinessLegalEntityAchBankAccount {
  export enum Type {
