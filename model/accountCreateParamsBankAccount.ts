 ...
 */
export class AccountCreateParamsBankAccount {
  /**
   * The bank account type
   */
  "type": AccountCreateParamsBankAccount.Type;
  /**
   ...
   */
  "currency": AccountCreateParamsBankAccount.Currency;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "AccountCreateParamsBankAccount.Currency",
    },
    {
      name: "bank_name",
      baseName: "bank_name",
  ...
  static getAttributeTypeMap() {
    return AccountCreateParamsBankAccount.attributeTypeMap;
  }
}

export namespace AccountCreateParamsBankAccount {
  export enum Type {
