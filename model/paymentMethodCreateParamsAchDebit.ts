 ...
 */
export class PaymentMethodCreateParamsAchDebit {
  /**
   * Bank account type.
   */
  "account_type": PaymentMethodCreateParamsAchDebit.AccountType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "PaymentMethodCreateParamsAchDebit.AccountType",
    },
    {
      name: "account_number",
  ...
  static getAttributeTypeMap() {
    return PaymentMethodCreateParamsAchDebit.attributeTypeMap;
  }
}

export namespace PaymentMethodCreateParamsAchDebit {
