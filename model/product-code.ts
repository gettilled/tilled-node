...
export type ProductCodePaymentMethodType =
  (typeof ProductCodePaymentMethodType)[keyof typeof ProductCodePaymentMethodType];
...
export type ProductCodeCurrency =
  (typeof ProductCodeCurrency)[keyof typeof ProductCodeCurrency];
export const ProductCodeRegion = {
  US: "US",
  CA: "CA",
} as const;

export type ProductCodeRegion =
  (typeof ProductCodeRegion)[keyof typeof ProductCodeRegion];
