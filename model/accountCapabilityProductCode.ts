 ...
 */
export class AccountCapabilityProductCode {
  /**
   ...
   */
  "payment_method_type": AccountCapabilityProductCode.PaymentMethodType;
  /**
   * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase.
   */
  "currency": AccountCapabilityProductCode.Currency;
  /**
   * The Region in which the product code is usable
   */
  "region"?: AccountCapabilityProductCode.Region;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: "AccountCapabilityProductCode.PaymentMethodType",
    },
    {
      name: "currency",
      baseName: "currency",
      type: "AccountCapabilityProductCode.Currency",
    },
    {
      name: "region",
      baseName: "region",
      type: "AccountCapabilityProductCode.Region",
    },
  ];

  static getAttributeTypeMap() {
    return AccountCapabilityProductCode.attributeTypeMap;
  }
}

export namespace AccountCapabilityProductCode {
