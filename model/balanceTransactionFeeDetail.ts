...
export class BalanceTransactionFeeDetail {
   ...
   */
  "currency": BalanceTransactionFeeDetail.Currency;
  /**
   * Type of the fee, one of: `platform_fee`, `tilled_fee` or `tax`.
   */
  "type": BalanceTransactionFeeDetail.Type;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "BalanceTransactionFeeDetail.Currency",
    },
    {
      name: "type",
      baseName: "type",
...
export namespace BalanceTransactionFeeDetail {
  ...
  export enum Type {
    ...
    TAX = <any>"tax",
    CHARGEBACK_FEE = <any>"chargeback_fee",
  }
}
