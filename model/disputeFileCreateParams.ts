...
export class DisputeFileCreateParams {
  /**
   * The type of evidence provided in the file.
   */
  "type": DisputeFileCreateParams.Type;
  /**
   * The id of the file.
   */
  "file_id": string;
  ...
  static getAttributeTypeMap() {
    return DisputeFileCreateParams.attributeTypeMap;
  }
}

export namespace DisputeFileCreateParams {
  export enum Type {
    CUSTOMER_COMMUNICATIONS = <any>"customer_communications",
    REFUND_POLICY = <any>"refund_policy",
    CANCELLATION_POLICY = <any>"cancellation_policy",
    CUSTOMER_SIGNATURE = <any>"customer_signature",
    RECEIPT = <any>"receipt",
    SERVICE_DOCUMENTATION = <any>"service_documentation",
    DUPLICATE_CHARGE_DOCUMENTATION = <any>"duplicate_charge_documentation",
    SHIPPING_DOCUMENTATION = <any>"shipping_documentation",
