...
export type ApiKeyCreateParamsType =
  (typeof ApiKeyCreateParamsType)[keyof typeof ApiKeyCreateParamsType];
export const ApiKeyCreateParamsScopes = {
  STAR: "*",
...
export type ApiKeyCreateParamsScopes =
  (typeof ApiKeyCreateParamsScopes)[keyof typeof ApiKeyCreateParamsScopes];
