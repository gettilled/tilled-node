...
export type PaymentIntentUpdateParamsPaymentMethodTypes =
  (typeof PaymentIntentUpdateParamsPaymentMethodTypes)[keyof typeof PaymentIntentUpdateParamsPaymentMethodTypes];
...
export type PaymentIntentUpdateParamsCurrency =
  (typeof PaymentIntentUpdateParamsCurrency)[keyof typeof PaymentIntentUpdateParamsCurrency];
export const PaymentIntentUpdateParamsCaptureMethod = {
  AUTOMATIC: "automatic",
  MANUAL: "manual",
} as const;

export type PaymentIntentUpdateParamsCaptureMethod =
  (typeof PaymentIntentUpdateParamsCaptureMethod)[keyof typeof PaymentIntentUpdateParamsCaptureMethod];
...
export type PaymentIntentUpdateParamsOccurrenceType =
  (typeof PaymentIntentUpdateParamsOccurrenceType)[keyof typeof PaymentIntentUpdateParamsOccurrenceType];
