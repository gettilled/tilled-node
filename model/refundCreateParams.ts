...
export class RefundCreateParams {
  /**
   ...
   */
  "refund_platform_fee"?: boolean = false;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "reason",
      baseName: "reason",
      type: "RefundCreateParams.Reason",
    },
    {
      name: "amount",
      baseName: "amount",
    ...
    },
    {
      ...
      baseName: "refund_platform_fee",
      type: "boolean",
    },
  ];

  static getAttributeTypeMap() {
    return RefundCreateParams.attributeTypeMap;
  }
}
