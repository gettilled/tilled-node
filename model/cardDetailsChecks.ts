...
export class CardDetailsChecks {
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "CardDetailsChecks.AddressLine1Check",
    },
    {
      name: "address_postal_code_check",
      baseName: "address_postal_code_check",
      type: "CardDetailsChecks.AddressPostalCodeCheck",
    },
    {
      name: "cvc_check",
      baseName: "cvc_check",
      type: "CardDetailsChecks.CvcCheck",
    },
  ];

  static getAttributeTypeMap() {
    return CardDetailsChecks.attributeTypeMap;
  }
}

export namespace CardDetailsChecks {
  export enum AddressLine1Check {
    PASS = <any>"pass",
    FAIL = <any>"fail",
    UNAVAILABLE = <any>"unavailable",
    UNCHECKED = <any>"unchecked",
  }
  export enum AddressPostalCodeCheck {
    PASS = <any>"pass",
    FAIL = <any>"fail",
    UNAVAILABLE = <any>"unavailable",
    UNCHECKED = <any>"unchecked",
