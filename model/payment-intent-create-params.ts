...
export type PaymentIntentCreateParamsPaymentMethodTypes =
  (typeof PaymentIntentCreateParamsPaymentMethodTypes)[keyof typeof PaymentIntentCreateParamsPaymentMethodTypes];
...
export type PaymentIntentCreateParamsCurrency =
  (typeof PaymentIntentCreateParamsCurrency)[keyof typeof PaymentIntentCreateParamsCurrency];
export const PaymentIntentCreateParamsCaptureMethod = {
  AUTOMATIC: "automatic",
  MANUAL: "manual",
} as const;

export type PaymentIntentCreateParamsCaptureMethod =
  (typeof PaymentIntentCreateParamsCaptureMethod)[keyof typeof PaymentIntentCreateParamsCaptureMethod];
...
export type PaymentIntentCreateParamsOccurrenceType =
  (typeof PaymentIntentCreateParamsOccurrenceType)[keyof typeof PaymentIntentCreateParamsOccurrenceType];
