 ...
 */
export class CheckoutSessionLineItemPriceData {
  /**
   * Three-letter ISO currency code, in lowercase.
   */
  "currency": CheckoutSessionLineItemPriceData.Currency;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "currency",
      baseName: "currency",
      type: "CheckoutSessionLineItemPriceData.Currency",
    },
    {
      name: "unit_amount",
    ...
    {
      name: "product_data",
      baseName: "product_data",
      type: "PriceProductData",
    },
  ];

  static getAttributeTypeMap() {
    return CheckoutSessionLineItemPriceData.attributeTypeMap;
  }
}

export namespace CheckoutSessionLineItemPriceData {
