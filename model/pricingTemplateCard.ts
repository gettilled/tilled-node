 ...
 */
export class PricingTemplateCard {
  /**
   * The type of transaction fee this pricing template applies.
   */
  "transaction_fee_type": PricingTemplateCard.TransactionFeeType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      baseName: "transaction_fee_type",
      type: "PricingTemplateCard.TransactionFeeType",
    },
    {
    ...
    {
      name: "chargeback_fee",
      baseName: "chargeback_fee",
      type: "number",
    },
    {
      name: "retrieval_fee",
      baseName: "retrieval_fee",
      type: "number",
    },
    {
      name: "reversal_fee",
      baseName: "reversal_fee",
      type: "number",
    },
  ];

  static getAttributeTypeMap() {
    return PricingTemplateCard.attributeTypeMap;
  }
}

export namespace PricingTemplateCard {
  export enum TransactionFeeType {
    FLAT_RATE = <any>"flat_rate",
