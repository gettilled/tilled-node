...
export namespace Payout {
  ...
  export enum Status {
    ...
    FAILED = <any>"failed",
    IN_TRANSIT = <any>"in_transit",
    PAID = <any>"paid",
    PENDING = <any>"pending",
  }
  export enum FailureCode {
    ACCOUNT_CLOSED = <any>"account_closed",
    ACCOUNT_FROZEN = <any>"account_frozen",
    BANK_ACCOUNT_RESTRICTED = <any>"bank_account_restricted",
    BANK_OWNERSHIP_CHANGED = <any>"bank_ownership_changed",
    COULD_NOT_PROCESS = <any>"could_not_process",
    DEBIT_NOT_AUTHORIZED = <any>"debit_not_authorized",
    DECLINED = <any>"declined",
    INVALID_ACCOUNT_NUMBER = <any>"invalid_account_number",
    INCORRECT_ACCOUNT_HOLDER_NAME = <any>"incorrect_account_holder_name",
    INCORRECT_ACCOUNT_HOLDER_ADDRESS = <any>"incorrect_account_holder_address",
    INCORRECT_ACCOUNT_HOLDER_TAX_ID = <any>"incorrect_account_holder_tax_id",
    INVALID_CURRENCY = <any>"invalid_currency",
    NO_ACCOUNT = <any>"no_account",
  }
}
