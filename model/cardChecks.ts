...
export class CardChecks {
   ...
   */
  "address_line1_check"?: CardChecks.AddressLine1Check;
  /**
   * If an address postal code was provided, results of the check, one of `pass`, `fail`, `unavailable`, or `unchecked`.
   */
  "address_postal_code_check"?: CardChecks.AddressPostalCodeCheck;
  /**
   * If a CVC was provided, results of the check, one of `pass`, `fail`, `unavailable`, or `unchecked`.
   */
  "cvc_check"?: CardChecks.CvcCheck;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "CardChecks.AddressLine1Check",
    },
    {
      name: "address_postal_code_check",
      baseName: "address_postal_code_check",
      type: "CardChecks.AddressPostalCodeCheck",
    },
    {
      name: "cvc_check",
      baseName: "cvc_check",
      type: "CardChecks.CvcCheck",
    },
  ];
