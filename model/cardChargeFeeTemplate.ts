...
export class CardChargeFeeTemplate {
  /**
   * The type of transaction fee this pricing template applies.
   */
  "transaction_fee_type": CardChargeFeeTemplate.TransactionFeeType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "CardChargeFeeTemplate.TransactionFeeType",
    },
    {
  ...
  static getAttributeTypeMap() {
    return CardChargeFeeTemplate.attributeTypeMap;
  }
}
