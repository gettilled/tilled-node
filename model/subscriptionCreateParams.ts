...
export class SubscriptionCreateParams {
  /**
   ...
   */
  "currency": SubscriptionCreateParams.Currency;
  /**
   ...
   */
  "interval_unit": SubscriptionCreateParams.IntervalUnit;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "SubscriptionCreateParams.Currency",
    },
    {
      name: "customer_id",
    ...
    },
    {
      ...
      type: "SubscriptionCreateParams.IntervalUnit",
    },
    {
      name: "price",
      baseName: "price",
  ...
  static getAttributeTypeMap() {
    return SubscriptionCreateParams.attributeTypeMap;
  }
}
