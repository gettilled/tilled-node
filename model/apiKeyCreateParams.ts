...
export class ApiKeyCreateParams {
  /**
   ...
   */
  "scopes"?: Array<ApiKeyCreateParams.Scopes>;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "scopes",
      baseName: "scopes",
      type: "Array<ApiKeyCreateParams.Scopes>",
    },
    {
      name: "name",
      baseName: "name",
  ...
  static getAttributeTypeMap() {
    return ApiKeyCreateParams.attributeTypeMap;
  }
}

export namespace ApiKeyCreateParams {
  export enum Type {
    PUBLISHABLE = <any>"publishable",
    SECRET = <any>"secret",
  }
  export enum Scopes {
    STAR = <any>"*",
    ACCOUNTSREAD = <any>"accounts:read",
    ACCOUNTSWRITE = <any>"accounts:write",
    ACCOUNTSDELETE = <any>"accounts:delete",
    API_KEYSREAD = <any>"api_keys:read",
    API_KEYSWRITE = <any>"api_keys:write",
    AUTH_LINKSREAD = <any>"auth_links:read",
    AUTH_LINKSWRITE = <any>"auth_links:write",
    BALANCE_TRANSACTIONSREAD = <any>"balance_transactions:read",
    CHARGESREAD = <any>"charges:read",
    CUSTOMERSREAD = <any>"customers:read",
    CUSTOMERSWRITE = <any>"customers:write",
    EVENTSREAD = <any>"events:read",
    PAYMENT_INTENTSREAD = <any>"payment_intents:read",
    PAYMENT_INTENTSWRITE = <any>"payment_intents:write",
    PAYMENT_METHODSREAD = <any>"payment_methods:read",
    PAYMENT_METHODSWRITE = <any>"payment_methods:write",
    PAYOUTSREAD = <any>"payouts:read",
    PAYOUTSWRITE = <any>"payouts:write",
    PLATFORM_FEESREAD = <any>"platform_fees:read",
    PRODUCT_CODESREAD = <any>"product_codes:read",
    REFUNDSREAD = <any>"refunds:read",
    REFUNDSWRITE = <any>"refunds:write",
    USERSREAD = <any>"users:read",
    USERSWRITE = <any>"users:write",
    WEBHOOK_ENDPOINTSREAD = <any>"webhook_endpoints:read",
    WEBHOOK_ENDPOINTSWRITE = <any>"webhook_endpoints:write",
    APPLE_PAY_DOMAINSREAD = <any>"apple_pay_domains:read",
    APPLE_PAY_DOMAINSWRITE = <any>"apple_pay_domains:write",
    BANK_ACCOUNTSREAD = <any>"bank_accounts:read",
    BANK_ACCOUNTSWRITE = <any>"bank_accounts:write",
    FILESREAD = <any>"files:read",
    FILESWRITE = <any>"files:write",
    USER_INVITATIONSREAD = <any>"user_invitations:read",
    USER_INVITATIONSWRITE = <any>"user_invitations:write",
    SUBSCRIPTIONSREAD = <any>"subscriptions:read",
    SUBSCRIPTIONSWRITE = <any>"subscriptions:write",
    DISPUTESREAD = <any>"disputes:read",
    DISPUTESWRITE = <any>"disputes:write",
    PRICING_TEMPLATESREAD = <any>"pricing_templates:read",
    PRICING_TEMPLATESWRITE = <any>"pricing_templates:write",
    CHECKOUT_SESSIONSREAD = <any>"checkout_sessions:read",
    CHECKOUT_SESSIONSWRITE = <any>"checkout_sessions:write",
  }
}
