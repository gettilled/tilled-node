 ...
 * The billing address.
 */
export class PaymentMethodCreateDebitSingleUseTokenParamsBillingDetailsAddress {
  /**
  ...
  static getAttributeTypeMap() {
    return PaymentMethodCreateDebitSingleUseTokenParamsBillingDetailsAddress.attributeTypeMap;
  }
}
