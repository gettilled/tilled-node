 ...
 */
export class PaymentMethodCreateAchDebitSingleUseTokenParamsBillingDetails {
  ...
  static getAttributeTypeMap() {
    return PaymentMethodCreateAchDebitSingleUseTokenParamsBillingDetails.attributeTypeMap;
  }
}
