...
export type PaymentIntentPaymentMethodTypes =
  (typeof PaymentIntentPaymentMethodTypes)[keyof typeof PaymentIntentPaymentMethodTypes];
...
export type PaymentIntentCurrency =
  (typeof PaymentIntentCurrency)[keyof typeof PaymentIntentCurrency];
...
export type PaymentIntentCaptureMethod =
  (typeof PaymentIntentCaptureMethod)[keyof typeof PaymentIntentCaptureMethod];
...
export type PaymentIntentCancellationReason =
  (typeof PaymentIntentCancellationReason)[keyof typeof PaymentIntentCancellationReason];
...
export type PaymentIntentOccurrenceType =
  (typeof PaymentIntentOccurrenceType)[keyof typeof PaymentIntentOccurrenceType];
