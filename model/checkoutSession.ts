...
export class CheckoutSession {
   ...
   */
  "payment_method_types": Array<CheckoutSession.PaymentMethodTypes>;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "Array<CheckoutSession.PaymentMethodTypes>",
    },
    {
      name: "updated_at",
      baseName: "updated_at",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "CheckoutSession.Currency",
    },
    {
      name: "status",
      baseName: "status",
      type: "CheckoutSession.Status",
    },
    {
      name: "metadata",
      baseName: "metadata",
