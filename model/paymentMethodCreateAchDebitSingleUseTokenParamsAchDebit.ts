 ...
 */
export class PaymentMethodCreateAchDebitSingleUseTokenParamsAchDebit {
  /**
   * Bank account type.
   */
  "account_type": PaymentMethodCreateAchDebitSingleUseTokenParamsAchDebit.AccountType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "PaymentMethodCreateAchDebitSingleUseTokenParamsAchDebit.AccountType",
    },
    {
      name: "account_number",
  ...
  static getAttributeTypeMap() {
    return PaymentMethodCreateAchDebitSingleUseTokenParamsAchDebit.attributeTypeMap;
  }
}

export namespace PaymentMethodCreateAchDebitSingleUseTokenParamsAchDebit {
