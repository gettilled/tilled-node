 ...
 */
export class ChargePlatformFee {
  /**
   ...
   */
  "currency": ChargePlatformFee.Currency;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      baseName: "payee_account_id",
      type: "string",
    },
    {
      name: "payer_account_id",
      baseName: "payer_account_id",
      type: "string",
    },
    {
      name: "amount",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "ChargePlatformFee.Currency",
    },
    {
      name: "refunded",
      baseName: "refunded",
  ...
  static getAttributeTypeMap() {
    return ChargePlatformFee.attributeTypeMap;
  }
}

export namespace ChargePlatformFee {
