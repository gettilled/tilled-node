...
export class DisputeFileFile {
   ...
   * The file type.
   */
  "type": DisputeFileFile.Type;
  /**
   * The file purpose.
   */
  "purpose": DisputeFileFile.Purpose;
  /**
   * The filename.
   */
  "filename": string;
  ...
  static getAttributeTypeMap() {
    return DisputeFileFile.attributeTypeMap;
  }
}

export namespace DisputeFileFile {
  export enum Type {
    PNG = <any>"png",
    JPG = <any>"jpg",
    PDF = <any>"pdf",
  ...
  export enum Purpose {
    ...
    ONBOARDING_DOCUMENTATION = <any>"onboarding_documentation",
  }
}
