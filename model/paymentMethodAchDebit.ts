 ...
 */
export class PaymentMethodAchDebit {
  /**
   ...
   * Account type
   */
  "account_type"?: PaymentMethodAchDebit.AccountType;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: "PaymentMethodAchDebit.AccountType",
    },
  ];

  static getAttributeTypeMap() {
    return PaymentMethodAchDebit.attributeTypeMap;
  }
}

export namespace PaymentMethodAchDebit {
