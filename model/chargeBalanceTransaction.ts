...
export class ChargeBalanceTransaction {
   ...
   */
  "status": ChargeBalanceTransaction.Status;
  /**
   ...
   */
  "currency": ChargeBalanceTransaction.Currency;
  /**
   ...
   */
  "source_type": ChargeBalanceTransaction.SourceType;
  /**
   ...
   * Transaction type.
   */
  "type": ChargeBalanceTransaction.Type;
  /**
   ...
   */
  "fee_subtype"?: ChargeBalanceTransaction.FeeSubtype;
  /**
   ...
   */
  "fee_type"?: ChargeBalanceTransaction.FeeType;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "status",
      baseName: "status",
      type: "ChargeBalanceTransaction.Status",
    },
    {
      name: "id",
      baseName: "id",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "ChargeBalanceTransaction.Currency",
    },
    {
      name: "fee",
      baseName: "fee",
    ...
    },
    {
      ...
      type: "ChargeBalanceTransaction.SourceType",
    },
    {
      name: "source_id",
      baseName: "source_id",
    ...
    },
    {
      ...
      type: "ChargeBalanceTransaction.FeeSubtype",
    },
    {
      name: "description",
    ...
    },
    {
      name: "fee_type",
      baseName: "fee_type",
      type: "ChargeBalanceTransaction.FeeType",
    },
    {
      name: "payout_id",
      baseName: "payout_id",
