...
export class UserInvitationCreateParams {
  /**
   ...
   */
  "role": UserInvitationCreateParams.Role;
  /**
   * Email address
   */
  "email": string;
   ...
   */
  "email_template"?: UserInvitationCreateParams.EmailTemplate;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "role",
      baseName: "role",
      type: "UserInvitationCreateParams.Role",
    },
    {
      name: "email",
      baseName: "email",
    ...
    },
    {
      ...
      type: "UserInvitationCreateParams.EmailTemplate",
    },
  ];

  static getAttributeTypeMap() {
    return UserInvitationCreateParams.attributeTypeMap;
  }
}
...
export namespace UserInvitationCreateParams {
  export enum Role {
    ...
    MERCHANT_OWNER = <any>"merchant_owner",
    MERCHANT_ADMIN = <any>"merchant_admin",
  }
  export enum EmailTemplate {
    MERCHANT_APPLICATION = <any>"merchant_application",
    NONE = <any>"none",
    CONSOLE_INVITATION = <any>"console_invitation",
  }
}
