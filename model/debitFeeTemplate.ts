...
export class DebitFeeTemplate {
  /**
   * The type of transaction fee this pricing template applies.
   */
  "transaction_fee_type": DebitFeeTemplate.TransactionFeeType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "DebitFeeTemplate.TransactionFeeType",
    },
    {
  ...
  static getAttributeTypeMap() {
    return DebitFeeTemplate.attributeTypeMap;
  }
}

export namespace DebitFeeTemplate {
