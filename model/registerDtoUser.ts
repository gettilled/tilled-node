...
export class RegisterDtoUser {
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "role",
      baseName: "role",
      type: "RegisterDtoUser.Role",
    },
    {
      name: "last_login_at",
      baseName: "last_login_at",
      type: "Date",
    },
    {
      name: "last_request_at",
      baseName: "last_request_at",
      type: "Date",
    },
    {
  ...
  static getAttributeTypeMap() {
    return RegisterDtoUser.attributeTypeMap;
  }
}

export namespace RegisterDtoUser {
  export enum Role {
    OWNER = <any>"owner",
    ADMIN = <any>"admin",
