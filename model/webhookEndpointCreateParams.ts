...
export class WebhookEndpointCreateParams {
  /**
   * The list of events to enable for this endpoint. You may specify `[\'*\']` to enable all events, except those that require explicit selection.
   */
  "enabled_events": WebhookEndpointCreateParams.EnabledEvents;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "WebhookEndpointCreateParams.EnabledEvents",
    },
    {
      name: "url",
      baseName: "url",
  ...
  static getAttributeTypeMap() {
    return WebhookEndpointCreateParams.attributeTypeMap;
  }
}
