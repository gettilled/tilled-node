 ...
 */
export class AchDebitSingleUseTokenDetails {
  /**
   ...
   * Account type
   */
  "account_type"?: AchDebitSingleUseTokenDetails.AccountType;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: "AchDebitSingleUseTokenDetails.AccountType",
    },
  ];

  static getAttributeTypeMap() {
    return AchDebitSingleUseTokenDetails.attributeTypeMap;
  }
}

export namespace AchDebitSingleUseTokenDetails {
