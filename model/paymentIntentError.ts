...
export class PaymentIntentError {
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "code",
      baseName: "code",
      type: "PaymentIntentError.Code",
    },
  ];

  static getAttributeTypeMap() {
    return PaymentIntentError.attributeTypeMap;
  }
}

export namespace PaymentIntentError {
  export enum Code {
    INSUFFICIENT_FUNDS = <any>"insufficient_funds",
    AVS_CHECK_FAILED = <any>"avs_check_failed",
    GENERIC_DECLINE = <any>"generic_decline",
    CALL_ISSUER = <any>"call_issuer",
    EXPIRED_CARD = <any>"expired_card",
    PICKUP_CARD = <any>"pickup_card",
    INVALID_NUMBER = <any>"invalid_number",
    LIMIT_EXCEEDED = <any>"limit_exceeded",
    NOT_PERMITTED = <any>"not_permitted",
    INCORRECT_CVC = <any>"incorrect_cvc",
    SERVICE_NOT_ALLOWED = <any>"service_not_allowed",
    INVALID_EXPIRY = <any>"invalid_expiry",
    CARD_NOT_SUPPORTED = <any>"card_not_supported",
    RESTRICTED_CARD = <any>"restricted_card",
    FRAUDULENT = <any>"fraudulent",
    PROCESSING_ERROR = <any>"processing_error",
    BANK_ACCOUNT_BLOCKED = <any>"bank_account_blocked",
    INTERNAL_ERROR = <any>"internal_error",
  }
}
