...
export class ProductCode {
   ...
   */
  "payment_method_type": ProductCode.PaymentMethodType;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      type: "ProductCode.PaymentMethodType",
    },
    {
      name: "currency",
      baseName: "currency",
      type: "ProductCode.Currency",
    },
    {
      name: "region",
      baseName: "region",
      type: "ProductCode.Region",
    },
  ];

  static getAttributeTypeMap() {
    return ProductCode.attributeTypeMap;
  }
}
