...
export const BalanceTransactionFeeSubtype = {
    ...
    ADDRESS_VERIFICATION_SERVICE: 'address_verification_service',
    ...
    DISCOVER_NETWORK_AUTHORIZATION: 'discover_network_authorization',
    ...
    VISA_CREDIT_VOUCHER: 'visa_credit_voucher',
    VISA_DEBIT_ASSESSMENT: 'visa_debit_assessment',
    VISA_INTERNATIONAL_ASSESSMENT: 'visa_international_assessment',
    VISA_ISSUER_NEVER_APPROVE_DOMESTIC_FEE: 'visa_issuer_never_approve_domestic_fee',
