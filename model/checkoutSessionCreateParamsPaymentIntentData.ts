 ...
 */
export class CheckoutSessionCreateParamsPaymentIntentData {
  /**
   * The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
   */
  "payment_method_types": Array<CheckoutSessionCreateParamsPaymentIntentData.PaymentMethodTypes>;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "Array<CheckoutSessionCreateParamsPaymentIntentData.PaymentMethodTypes>",
    },
    {
      name: "metadata",
      baseName: "metadata",
  ...
  static getAttributeTypeMap() {
    return CheckoutSessionCreateParamsPaymentIntentData.attributeTypeMap;
  }
}

export namespace CheckoutSessionCreateParamsPaymentIntentData {
