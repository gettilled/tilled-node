...
export interface AccountRole {
    /**
     * The ID of the account associated with this role.
     * @type {string}
     * @memberof AccountRole
     */
    'account_id': string;
    /**
     * The user\'s role in this account. The roles have varied restrictions on the actions they can take.
     * @type {string}
     * @memberof AccountRole
     */
...
export type AccountRoleRole = typeof AccountRoleRole[keyof typeof AccountRoleRole];
