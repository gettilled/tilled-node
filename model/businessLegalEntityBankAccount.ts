 ...
 */
export class BusinessLegalEntityBankAccount {
  /**
   ...
   */
  "type"?: BusinessLegalEntityBankAccount.Type;
  /**
  ...
  static getAttributeTypeMap() {
    return BusinessLegalEntityBankAccount.attributeTypeMap;
  }
}

export namespace BusinessLegalEntityBankAccount {
  export enum Type {
