...
export type BusinessLegalEntityType =
  (typeof BusinessLegalEntityType)[keyof typeof BusinessLegalEntityType];
...
export type BusinessLegalEntityCategory =
  (typeof BusinessLegalEntityCategory)[keyof typeof BusinessLegalEntityCategory];
...
export type BusinessLegalEntityCurrency =
  (typeof BusinessLegalEntityCurrency)[keyof typeof BusinessLegalEntityCurrency];
...
export type BusinessLegalEntityYearlyVolumeRange =
  (typeof BusinessLegalEntityYearlyVolumeRange)[keyof typeof BusinessLegalEntityYearlyVolumeRange];
export const BusinessLegalEntityRegion = {
  US: "US",
  CA: "CA",
} as const;

export type BusinessLegalEntityRegion =
  (typeof BusinessLegalEntityRegion)[keyof typeof BusinessLegalEntityRegion];
...
export type BusinessLegalEntityLocale =
  (typeof BusinessLegalEntityLocale)[keyof typeof BusinessLegalEntityLocale];
