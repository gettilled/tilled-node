 ...
 */
export class PlatformFeeBalanceTransaction {
  /**
   ...
   */
  "status": PlatformFeeBalanceTransaction.Status;
  /**
   ...
   */
  "currency": PlatformFeeBalanceTransaction.Currency;
  /**
   ...
   */
  "source_type": PlatformFeeBalanceTransaction.SourceType;
  /**
   ...
   * Transaction type.
   */
  "type": PlatformFeeBalanceTransaction.Type;
  /**
   ...
   */
  "fee_subtype"?: PlatformFeeBalanceTransaction.FeeSubtype;
  /**
   ...
   */
  "fee_type"?: PlatformFeeBalanceTransaction.FeeType;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "status",
      baseName: "status",
      type: "PlatformFeeBalanceTransaction.Status",
    },
    {
      name: "id",
      baseName: "id",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "PlatformFeeBalanceTransaction.Currency",
    },
    {
      name: "fee",
      baseName: "fee",
    ...
    },
    {
      ...
      type: "PlatformFeeBalanceTransaction.SourceType",
    },
    {
      name: "source_id",
      baseName: "source_id",
    ...
    },
    {
      ...
      type: "PlatformFeeBalanceTransaction.FeeSubtype",
    },
    {
      name: "description",
    ...
    },
    {
      name: "fee_type",
      baseName: "fee_type",
      type: "PlatformFeeBalanceTransaction.FeeType",
    },
    {
      name: "payout_id",
      baseName: "payout_id",
  ...
  static getAttributeTypeMap() {
    return PlatformFeeBalanceTransaction.attributeTypeMap;
  }
}

export namespace PlatformFeeBalanceTransaction {
  export enum Status {
