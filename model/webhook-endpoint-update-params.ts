...
export interface WebhookEndpointUpdateParams {
   ...
   */
  enabled_events?: WebhookEndpointUpdateParamsEnabledEvents;
  /**
...
export type WebhookEndpointUpdateParamsEnabledEvents =
  (typeof WebhookEndpointUpdateParamsEnabledEvents)[keyof typeof WebhookEndpointUpdateParamsEnabledEvents];
