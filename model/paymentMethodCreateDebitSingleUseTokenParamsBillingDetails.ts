...
export class PaymentMethodCreateDebitSingleUseTokenParamsBillingDetails {
  ...
  static getAttributeTypeMap() {
    return PaymentMethodCreateDebitSingleUseTokenParamsBillingDetails.attributeTypeMap;
  }
}
