...
export namespace Refund {
  ...
  export enum FailureCode {
    EXPIRED_OR_CANCELED_CARD = <any>"expired_or_canceled_card",
    LOST_OR_STOLEN_CARD = <any>"lost_or_stolen_card",
    FRAUDULENT = <any>"fraudulent",
    DECLINED = <any>"declined",
    PROPRIETARY_CARD_ACTIVITY_REGULATIONS = <any>(
      "proprietary_card_activity_regulations"
    ),
    BLACKLISTED_CARD = <any>"blacklisted_card",
  ...
  export enum Reason {
    ...
    PARTIAL_CAPTURE = <any>"partial_capture",
  }
}
