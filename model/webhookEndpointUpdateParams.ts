...
export class WebhookEndpointUpdateParams {
  /**
   * The list of events to enable for this endpoint. You may specify `[\'*\']` to enable all events, except those that require explicit selection.
   */
  "enabled_events"?: WebhookEndpointUpdateParams.EnabledEvents;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "WebhookEndpointUpdateParams.EnabledEvents",
    },
    {
      name: "url",
      baseName: "url",
  ...
  static getAttributeTypeMap() {
    return WebhookEndpointUpdateParams.attributeTypeMap;
  }
}

export namespace WebhookEndpointUpdateParams {
  export enum EnabledEvents {
    STAR = <any>"*",
    ACCOUNT_UPDATED = <any>"account.updated",
    CHARGE_CAPTURED = <any>"charge.captured",
    CHARGE_EXPIRED = <any>"charge.expired",
    CHARGE_FAILED = <any>"charge.failed",
    CHARGE_SUCCEEDED = <any>"charge.succeeded",
    CHARGE_PENDING = <any>"charge.pending",
    CHARGE_REFUNDED = <any>"charge.refunded",
    CHARGE_REFUND_UPDATED = <any>"charge.refund.updated",
    CHARGE_UPDATED = <any>"charge.updated",
    CUSTOMER_CREATED = <any>"customer.created",
    CUSTOMER_DELETED = <any>"customer.deleted",
    CUSTOMER_UPDATED = <any>"customer.updated",
    DISPUTE_CREATED = <any>"dispute.created",
    DISPUTE_UPDATED = <any>"dispute.updated",
    PAYMENT_INTENT_CANCELED = <any>"payment_intent.canceled",
    PAYMENT_INTENT_CREATED = <any>"payment_intent.created",
    PAYMENT_INTENT_PAYMENT_FAILED = <any>"payment_intent.payment_failed",
    PAYMENT_INTENT_PROCESSING = <any>"payment_intent.processing",
    PAYMENT_INTENT_REQUIRES_ACTION = <any>"payment_intent.requires_action",
    PAYMENT_INTENT_SUCCEEDED = <any>"payment_intent.succeeded",
    PAYMENT_INTENT_AMOUNT_CAPTURABLE_UPDATED = <any>(
      "payment_intent.amount_capturable_updated"
    ),
    PAYMENT_METHOD_ATTACHED = <any>"payment_method.attached",
    PAYMENT_METHOD_DETACHED = <any>"payment_method.detached",
    PAYOUT_CREATED = <any>"payout.created",
    PAYOUT_FAILED = <any>"payout.failed",
    PAYOUT_PAID = <any>"payout.paid",
    PAYOUT_UPDATED = <any>"payout.updated",
    PLATFORM_FEE_CREATED = <any>"platform_fee.created",
    PLATFORM_FEE_REFUNDED = <any>"platform_fee.refunded",
    SUBSCRIPTION_CREATED = <any>"subscription.created",
    SUBSCRIPTION_CANCELED = <any>"subscription.canceled",
    SUBSCRIPTION_UPDATED = <any>"subscription.updated",
    REPORT_RUN_SUCCEEDED = <any>"report_run.succeeded",
    REPORT_RUN_FAILED = <any>"report_run.failed",
  }
}
