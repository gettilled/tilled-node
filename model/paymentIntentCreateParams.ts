...
export class PaymentIntentCreateParams {
  /**
   * The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
   */
  "payment_method_types": Array<PaymentIntentCreateParams.PaymentMethodTypes>;
  /**
   ...
   */
  "occurrence_type"?: PaymentIntentCreateParams.OccurrenceType;
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "Array<PaymentIntentCreateParams.PaymentMethodTypes>",
    },
    {
      name: "amount",
      baseName: "amount",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "PaymentIntentCreateParams.Currency",
    },
    {
      name: "metadata",
      baseName: "metadata",
    ...
    },
    {
      ...
      type: "PaymentIntentCreateParams.CaptureMethod",
    },
    {
      name: "confirm",
      baseName: "confirm",
    ...
    },
    {
      ...
      type: "PaymentIntentCreateParams.OccurrenceType",
    },
    {
      name: "level3",
      baseName: "level3",
  ...
  static getAttributeTypeMap() {
    return PaymentIntentCreateParams.attributeTypeMap;
  }
}
