...
export class PricingTemplate {
   ...
   */
  "payment_method_type": PricingTemplate.PaymentMethodType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "PricingTemplate.PaymentMethodType",
    },
    {
      name: "id",
      baseName: "id",
  ...
  static getAttributeTypeMap() {
    return PricingTemplate.attributeTypeMap;
  }
}
