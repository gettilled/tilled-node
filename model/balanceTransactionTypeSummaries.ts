...
export class BalanceTransactionTypeSummaries {
  /**
   * String indicating the unit of time to aggregate the summary of data.
   */
  "time_unit": BalanceTransactionTypeSummaries.TimeUnit;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      name: "time_unit",
      baseName: "time_unit",
      type: "BalanceTransactionTypeSummaries.TimeUnit",
    },
    {
      name: "start_time",
      baseName: "start_time",
  ...
  static getAttributeTypeMap() {
    return BalanceTransactionTypeSummaries.attributeTypeMap;
  }
}

export namespace BalanceTransactionTypeSummaries {
