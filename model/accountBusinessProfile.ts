...
export class AccountBusinessProfile {
   ...
   * MCC category.
   */
  "category": AccountBusinessProfile.Category;
  /**
   ...
   */
  "locale": AccountBusinessProfile.Locale;
  /**
   ...
   */
  "region": AccountBusinessProfile.Region;
  /**
   * The structure of the business (LLC, Corp, etc.).
   */
  "structure": AccountBusinessProfile.Structure;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "category",
      baseName: "category",
      type: "AccountBusinessProfile.Category",
    },
    {
      name: "legal_name",
      baseName: "legal_name",
    ...
    },
    {
      name: "locale",
      baseName: "locale",
      type: "AccountBusinessProfile.Locale",
    },
    {
      name: "phone",
      baseName: "phone",
    ...
    },
    {
      name: "region",
      baseName: "region",
      type: "AccountBusinessProfile.Region",
    },
    {
      name: "structure",
      baseName: "structure",
      type: "AccountBusinessProfile.Structure",
    },
    {
...
export namespace AccountBusinessProfile {
