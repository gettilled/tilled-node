...
export type BusinessProfileCategory =
  (typeof BusinessProfileCategory)[keyof typeof BusinessProfileCategory];
...
export type BusinessProfileLocale =
  (typeof BusinessProfileLocale)[keyof typeof BusinessProfileLocale];
export const BusinessProfileRegion = {
  US: "US",
  CA: "CA",
} as const;

export type BusinessProfileRegion =
  (typeof BusinessProfileRegion)[keyof typeof BusinessProfileRegion];
