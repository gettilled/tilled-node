 ...
 */
export class AccountCapabilityPricingTemplate {
  /**
   * The payment method type this pricing template applies to.
   */
  "payment_method_type": AccountCapabilityPricingTemplate.PaymentMethodType;
  /**
   ...
   */
  "currency": AccountCapabilityPricingTemplate.Currency;
  /**
   ...
   */
  "status": AccountCapabilityPricingTemplate.Status;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "AccountCapabilityPricingTemplate.PaymentMethodType",
    },
    {
      name: "id",
      baseName: "id",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "AccountCapabilityPricingTemplate.Currency",
    },
    {
      name: "account_monthly_fee",
      baseName: "account_monthly_fee",
      type: "number",
    },
    {
      name: "account_monthly_minimum_fee",
      baseName: "account_monthly_minimum_fee",
      type: "number",
    },
    {
      name: "status",
      baseName: "status",
      type: "AccountCapabilityPricingTemplate.Status",
    },
    {
      name: "created_at",
      baseName: "created_at",
  ...
  static getAttributeTypeMap() {
    return AccountCapabilityPricingTemplate.attributeTypeMap;
  }
}

export namespace AccountCapabilityPricingTemplate {
