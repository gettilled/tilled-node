 ...
 * 
 * @export
 * @interface PaymentIntentDataCreateParams
 */
export interface PaymentIntentDataCreateParams {
    /**
     * The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
     * @type {Array<string>}
     * @memberof PaymentIntentDataCreateParams
     */
    'payment_method_types': Array<PaymentIntentDataCreateParamsPaymentMethodTypes>;
    /**
