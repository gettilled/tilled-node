...
export interface WebhookEndpointCreateParams {
   ...
   */
  enabled_events: WebhookEndpointCreateParamsEnabledEvents;
  /**
...
export const WebhookEndpointCreateParamsEnabledEvents = {
  STAR: "*",
...
export type WebhookEndpointCreateParamsEnabledEvents =
  (typeof WebhookEndpointCreateParamsEnabledEvents)[keyof typeof WebhookEndpointCreateParamsEnabledEvents];
