 ...
 */
export class RegisterDtoAccount {
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    {
      name: "terminal_readers",
      baseName: "terminal_readers",
    ...
    },
    {
      ...
      baseName: "white_label_domain",
      type: "string",
    },
    {
      name: "merchant_support",
      baseName: "merchant_support",
      type: "boolean",
    },
  ];

  static getAttributeTypeMap() {
    return RegisterDtoAccount.attributeTypeMap;
  }
}

export namespace RegisterDtoAccount {
  export enum Type {
    PARTNER = <any>"partner",
