...
export class BankAccountCreateParams {
  /**
   * The bank account type
   */
  "type": BankAccountCreateParams.Type;
  /**
   ...
   */
  "currency": BankAccountCreateParams.Currency;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "BankAccountCreateParams.Currency",
    },
    {
      name: "bank_name",
      baseName: "bank_name",
  ...
  static getAttributeTypeMap() {
    return BankAccountCreateParams.attributeTypeMap;
  }
}
