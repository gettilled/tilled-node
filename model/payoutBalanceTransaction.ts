...
export class PayoutBalanceTransaction {
   ...
   */
  "status": PayoutBalanceTransaction.Status;
  /**
   ...
   */
  "currency": PayoutBalanceTransaction.Currency;
  /**
   ...
   */
  "source_type": PayoutBalanceTransaction.SourceType;
  /**
   ...
   * Transaction type.
   */
  "type": PayoutBalanceTransaction.Type;
  /**
   ...
   */
  "fee_subtype"?: PayoutBalanceTransaction.FeeSubtype;
  /**
   ...
   */
  "fee_type"?: PayoutBalanceTransaction.FeeType;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "status",
      baseName: "status",
      type: "PayoutBalanceTransaction.Status",
    },
    {
      name: "id",
      baseName: "id",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "PayoutBalanceTransaction.Currency",
    },
    {
      name: "fee",
      baseName: "fee",
    ...
    },
    {
      ...
      type: "PayoutBalanceTransaction.SourceType",
    },
    {
      name: "source_id",
      baseName: "source_id",
    ...
    },
    {
      ...
      type: "PayoutBalanceTransaction.FeeSubtype",
    },
    {
      name: "description",
    ...
    },
    {
      name: "fee_type",
      baseName: "fee_type",
      type: "PayoutBalanceTransaction.FeeType",
    },
    {
      name: "payout_id",
      baseName: "payout_id",
