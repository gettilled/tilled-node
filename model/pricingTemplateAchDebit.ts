 ...
 */
export class PricingTemplateAchDebit {
  /**
   * The type of transaction fee this pricing template applies.
   */
  "transaction_fee_type": PricingTemplateAchDebit.TransactionFeeType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "PricingTemplateAchDebit.TransactionFeeType",
    },
    {
  ...
  static getAttributeTypeMap() {
    return PricingTemplateAchDebit.attributeTypeMap;
  }
}

export namespace PricingTemplateAchDebit {
