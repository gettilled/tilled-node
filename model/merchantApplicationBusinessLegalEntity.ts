 ...
 */
export class MerchantApplicationBusinessLegalEntity {
  /**
   ...
   */
  "type": MerchantApplicationBusinessLegalEntity.Type;
  /**
   * The merchant name
   */
  "name": string;
   ...
   */
  "category": MerchantApplicationBusinessLegalEntity.Category;
  /**
   ...
   */
  "currency": MerchantApplicationBusinessLegalEntity.Currency;
  /**
   * Estimated yearly volume of transactions of the business. * `LOW` = 0-50k * `MEDIUM` = 50-100k * `HIGH` = 100-250k * `VERY_HIGH` = 250k+
   */
  "yearly_volume_range": MerchantApplicationBusinessLegalEntity.YearlyVolumeRange;
  /**
   ...
   */
  "region": MerchantApplicationBusinessLegalEntity.Region;
  /**
   * The locale value used for the merchant account. Values depend on the region.
   */
  "locale": MerchantApplicationBusinessLegalEntity.Locale;
  /**
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "category",
      baseName: "category",
      type: "MerchantApplicationBusinessLegalEntity.Category",
    },
    {
      name: "phone",
      baseName: "phone",
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "MerchantApplicationBusinessLegalEntity.Currency",
    },
    {
      name: "yearly_volume_range",
      baseName: "yearly_volume_range",
      type: "MerchantApplicationBusinessLegalEntity.YearlyVolumeRange",
    },
    {
    ...
    },
    {
      name: "region",
      baseName: "region",
      type: "MerchantApplicationBusinessLegalEntity.Region",
    },
    {
      name: "locale",
      baseName: "locale",
      type: "MerchantApplicationBusinessLegalEntity.Locale",
    },
    {
  ...
  static getAttributeTypeMap() {
    return MerchantApplicationBusinessLegalEntity.attributeTypeMap;
  }
}
