...
export class AccountCapability {
  /**
   ...
   */
  "status": AccountCapability.Status;
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      baseName: "pricing_template",
      type: "AccountCapabilityPricingTemplate",
    },
    {
      name: "requirements_errors",
      baseName: "requirements_errors",
      type: "Array<AccountRequirementsError>",
    },
    {
      name: "onboarding_application_progress",
      baseName: "onboarding_application_progress",
      type: "number",
    },
    {
      name: "onboarding_application_url",
      baseName: "onboarding_application_url",
      type: "string",
    },
  ];

  static getAttributeTypeMap() {
    return AccountCapability.attributeTypeMap;
  }
}
