...
export class PaymentIntentDataCreateParams {
  /**
   * The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
   */
  "payment_method_types": Array<PaymentIntentDataCreateParams.PaymentMethodTypes>;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "Array<PaymentIntentDataCreateParams.PaymentMethodTypes>",
    },
    {
      name: "metadata",
      baseName: "metadata",
  ...
  static getAttributeTypeMap() {
    return PaymentIntentDataCreateParams.attributeTypeMap;
  }
}

export namespace PaymentIntentDataCreateParams {
