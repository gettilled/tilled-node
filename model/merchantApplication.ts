...
export class MerchantApplication {
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      ...
      baseName: "pricing_templates",
      type: "Array<PricingTemplate>",
    },
    {
      name: "terms_and_conditions_links",
      baseName: "terms_and_conditions_links",
      type: "Array<TermsAndConditionsDetail>",
    },
    {
      name: "validation_errors",
      baseName: "validation_errors",
      type: "Array<string>",
    },
    {
      name: "business_legal_entity",
      baseName: "business_legal_entity",
  ...
  static getAttributeTypeMap() {
    return MerchantApplication.attributeTypeMap;
  }
}
