...
export class BalanceTransactionTypeSummary {
  ...
  static attributeTypeMap: Array<{
    ...
    },
    {
      name: "currency",
      baseName: "currency",
      type: "BalanceTransactionTypeSummary.Currency",
    },
    {
      name: "amount",
      baseName: "amount",
  ...
  static getAttributeTypeMap() {
    return BalanceTransactionTypeSummary.attributeTypeMap;
  }
}

export namespace BalanceTransactionTypeSummary {
  export enum Type {
    CHARGE = <any>"charge",
