 ...
 */
export class PricingTemplateEftDebit {
  /**
   * The type of transaction fee this pricing template applies.
   */
  "transaction_fee_type": PricingTemplateEftDebit.TransactionFeeType;
  /**
  ...
  static attributeTypeMap: Array<{
  ...
  }> = [
    {
      ...
      type: "PricingTemplateEftDebit.TransactionFeeType",
    },
    {
  ...
  static getAttributeTypeMap() {
    return PricingTemplateEftDebit.attributeTypeMap;
  }
}

export namespace PricingTemplateEftDebit {
